<%@ Page Title="" Language="C#" MasterPageFile="MasterPage.master" AutoEventWireup="true" CodeFile="Recipt.aspx.cs" Inherits="arazi3435_menu1" %>
				...
				<td class="style5">
					<table style="width:100%;height:240px;">
						...
						<tr>
                            ...
                            <td class="style3">Pay To</td><td>
                            <asp:TextBox ID="TextBox11" runat="server" style="width:120Px;" AutoPostBack="True" OnTextChanged="TextBox11_TextChanged"></asp:TextBox> <asp:Label ID="Label222" runat="server" style="font-weight: 700; color: #FF0000" 
                                    Text=""></asp:Label>
                            </td>
						</tr>
						<tr>
