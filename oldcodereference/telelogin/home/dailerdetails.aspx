            ...
            <tr>
                <td class="style3" colspan="5" bgcolor="#CCCCCC">
                    ...
                    <asp:DropDownList ID="DropDownList1" runat="server" Height="19px" 
                        ...
                        <asp:ListItem>HEED</asp:ListItem>
                        <asp:ListItem>ASHOK</asp:ListItem>
                        <asp:ListItem>MUFTI</asp:ListItem>
                    </asp:DropDownList>
                    </strong>
                </td>
            </tr>
                    ...
                    <asp:Panel ID="Panel2" runat="server" Height="57px" BackColor="#AAFFDD">
                        <table class="style1">
                            ...
                            <tr>
                                ...
                                <td>
                                    <asp:Button ID="Button2" runat="server" CssClass="style14" Height="27px" 
                                        Text="SEARCH" Width="96px" />
                                </td>
                            </tr>
                        </table>
                    </asp:Panel>
            ...
            <tr>
                <td colspan="5">
                    <asp:GridView ID="GridView1" runat="server" BackColor="White" 
                        ...
                        <Columns>
                            <asp:BoundField HeaderText="REGNO" />
                            <asp:BoundField HeaderText="NAME" />
                            <asp:BoundField HeaderText="ARAZI" />
                            <asp:BoundField HeaderText="PLOTNO" />
                            <asp:BoundField HeaderText="SIZE" />
                            <asp:BoundField HeaderText="STATUS" />
                            <asp:BoundField HeaderText="DURATION" />
                            <asp:BoundField HeaderText="CALL DATE" />
                            <asp:BoundField HeaderText="FEEDBACK" />
                            <asp:BoundField HeaderText="GIVEN DATE" />
                            <asp:BoundField HeaderText="RECORDING" />
                        </Columns>
