<%@ Page Title="" Language="C#" MasterPageFile="~/chain system/admin/agenthome/agentmaster.master" AutoEventWireup="true" CodeFile="teamagent.aspx.cs" Inherits="admin_agenthome_agentself" %>
...
<div class="content-wrapper" style="min-height: 428.016px;">
  ...
  <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h4 class="m-0 text-success font-weight-bold">Associate Direct Joining 
               </h4>
          </div><!-- /.col -->
            ...
            <div class="card shadow-none ">
              <div class="card-body overflow-auto">
                <div id="example3_wrapper" class="dataTables_wrapper dt-bootstrap4 no-footer"><div class="row">
                 <div>
                 <asp:ImageButton ID="btnPrint" runat="server" ImageUrl="~/chain system/admin/agenthome/print.png" 
                     style="height:30px;width:30px;" onclick="btnPrint_Click"/> &nbsp;&nbsp;&nbsp;&nbsp;<asp:ImageButton 
                     ID="ImageButton2" runat="server" ImageUrl="~/chain system/admin/agenthome/excel.png"  
                     style="height:30px;width:30px;" onclick="ExportToExcel" /> &nbsp;&nbsp;&nbsp;&nbsp;<a href="cs1.aspx" target=_blank>View Graph</a></div>
