...
public partial class dialer_advocatemenu : System.Web.UI.Page
{
    ...
    protected void Button2_Click(object sender, EventArgs e)
    {
        ...
        con.Open();
        SqlDataAdapter da = new SqlDataAdapter("select RECIPT,CUSTREGNO,SUBSTRING(ASCADDRESS,1,15) AS 'NAME',DATE1,AMOUNTR from  recipt3 where RECIPT='" + TextBox2.Text + "'", con);
