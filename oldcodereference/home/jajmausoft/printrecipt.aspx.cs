    ...
    protected void Button2_Click(object sender, EventArgs e)
    {
        try
        {
            ...
            if (ds.Tables[0].Rows.Count > 0)
            {
             ...
             con1.Open();
             SqlDataAdapter da1 = new SqlDataAdapter("select date3 from customerreg3 where CUSTREGNO='"+TextBox3.Text+"'", con1);
             DataSet ds1 = new DataSet();
             da1.Fill(ds1);
             con1.Close();
      ...
      DateTime date56 = Convert.ToDateTime(Label29.Text);
        ...
        // string relationship;
         ...
         else
         {
            ...
            SqlDataAdapter cmd = new SqlDataAdapter("select chequenopay from recipt3 where RECIPT='" + TextBox1.Text + "'", con1);
            DataSet ds = new DataSet();
            cmd.Fill(ds);
            con1.Close();
