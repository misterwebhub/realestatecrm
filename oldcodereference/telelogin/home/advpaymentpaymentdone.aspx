<%@ Page Language="C#" AutoEventWireup="true" CodeFile="advpaymentpaymentdone.aspx.cs" Inherits="dialer_paymentdone" %>
...
<body>
    ...
    <div style="width:100%;"><table class="auto-style15"><tr><td class="auto-style14">
        <asp:Button ID="Button4" runat="server" BackColor="#66FF99" 
            ...
            OnClick="Button4_Click" Text="ADVOCATE" style="height: 26px" />
        ...
        <asp:Panel ID="Panel1" runat="server">
                   <div class="auto-style17">
                       ...
                       <table class="auto-style2">
                           <tr>
                               <td style="text-align:center; background-color: #008080;" class="auto-style18">ADVOCATE PAYMENT (21/Aug/2022)</td>
                           </tr>
                           <tr>
...
&nbsp;&nbsp;&nbsp;
                           ...
                           <tr>
                               <td class="auto-style19" style="background-color: #FFCCFF"><strong>NAME
                                   <asp:DropDownList ID="DropDownList5" runat="server" Height="25px">
                                   </asp:DropDownList>
                                   &nbsp; FROM</strong> <strong>
                                   <asp:TextBox ID="TextBox11" runat="server" Height="25px" Width="109px"></asp:TextBox>
                                   &nbsp;&nbsp; TO&nbsp;
                                   <asp:TextBox ID="TextBox12" runat="server" Height="25px" Width="109px"></asp:TextBox>
                                   &nbsp;&nbsp;
                                       ...
                                       <table class="auto-style2">
                                           <tr>
                                               <td bgcolor="Black" class="style1">
                                                   <strong>EXPENSES OF ADVANCE PAYMENT&nbsp; &nbsp;&nbsp; &nbsp;
                                                   </strong></td>
                                           </tr>
                                           <tr>
                                               <td>
        ...
        <asp:Panel ID="Panel2" runat="server">
                   <div style="height:100%;width:100%;">
                       <table class="auto-style11">
                           <tr>
                                <td style="text-align:center; background-color: bisque;" class="auto-style16">DAKHIL-KHARIJ PAYMENT</td>
                              
                           </tr>
                           <tr>
                               <td class="auto-style6"><strong>ADD NAME</strong>&nbsp;
...
&nbsp;&nbsp; <strong>
                           ...
                           <tr>
                               <td class="auto-style12"><strong>NAME &nbsp;
...
&nbsp;&nbsp;&nbsp;
                           ...
                           <tr>
                               <td class="auto-style9" style="background-color: #FFFF99"><strong>NAME
