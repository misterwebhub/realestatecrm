<%@ Page Language="C#" AutoEventWireup="true" CodeFile="officesummery.aspx.cs" Inherits="excel_office_summery" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">

<html>

<head><title>Office Summery Form</title>
...
&nbsp;&nbsp;  
<table>
<tr><th colspan="4" style="text-align:center;" class="style2" bgcolor="#FFFF66">MONTH WISE 
    OFFICE SUMMERY</th></tr>
...
<tr><th class="style3" colspan="2">USER&nbsp;&nbsp;
    ...
    <asp:Button ID="Button1" runat="server" class="b" Text="ALL USER WISE" Width="183px" 
        onclick="Button1_Click" Font-Bold="True" Height="28px" /></th>
    <th class="style12">
...
<tr><th class="style15" colspan="2" bgcolor="#CCFFFF">Total Bond = 
    <asp:Label ID="Label1" runat="server" Text="" style="font-size: large"></asp:Label>
    &nbsp;
    </th><th class="style15" bgcolor="#CCFFFF">
        <span class="style18">Cancel = </span>
        <asp:Label ID="Label9" runat="server" style="color: #FF3300" Text=""></asp:Label>
    </th>
    <th class="style14" bgcolor="#CCFFFF" >Bal Bond=
        <asp:Label ID="Label10" runat="server" style="color: #006600" Text="Label"></asp:Label>
    </th>
</tr>
<tr><th class="style15" colspan="4" bgcolor="#FFFFCC">TOTAL AMOUNT&nbsp; -&nbsp;
    <asp:Label ID="Label12" runat="server" Text="" style="font-size: large"></asp:Label>
        &nbsp;
    <asp:Button ID="Button5" runat="server" onclick="Button5_Click" 
        style="font-weight: 700" Text="DETAILS" />
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; NEW AMOUNT -&nbsp; <asp:Label ID="Label8" runat="server" Text="" style="font-size: large"></asp:Label>
    &nbsp;
        <asp:Button ID="Button3" runat="server" onclick="Button3_Click" 
            style="font-weight: 700" Text="DETAILS" Width="72px" />
    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; EMI AMOUNT -&nbsp;
        <asp:Label ID="Label13" runat="server" Text="" style="font-size: large"></asp:Label>
    &nbsp;
        <asp:Button ID="Button4" runat="server" onclick="Button4_Click" 
            style="font-weight: 700" Text="DETAILS" Width="71px" />
    </th>
</tr>
<tr><th colspan="4">
