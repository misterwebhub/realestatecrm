...
using (HttpResponseMessage  response = await client.SendAsync(request))
{
   ...
   // Console.WriteLine(body);
    ...
    public void arazisearch(Double custotalpayment, string arazi, Double totalrecieve)
    {
        ...
        if (arazi == "152" || arazi == "506" || arazi == "519" || arazi == "239" || arazi == "161GHA" || arazi == "186MI" || arazi == "RAMAI137" || arazi == "357" || arazi == "320" || arazi == "2001GA" || arazi == "217" || arazi == "340" || arazi == "353" || arazi == "513RA")
        {
