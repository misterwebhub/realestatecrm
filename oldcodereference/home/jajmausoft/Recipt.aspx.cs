...
public partial class Recipt : System.Web.UI.Page
{
    ...
    public void search()
    {
        try
        {
            ...
            con1.Open();
            amt = 0;
            SqlDataAdapter cmd = new SqlDataAdapter("select SUM(AMOUNTR) from recipt3 where CUSTREGNO='" + TextBox1.Text + "'", con1);
    ...
    public void entry(string usertype, string cheq)
    {
        try
        {
            ...
            {
                rectype = DropDownList3.Text;
				disprice=Convert.ToInt32(Label20.Text);
            }
            SqlCommand cmd = new SqlCommand("insert into recipt3(CUSTREGNO,ASCNAME,RECIPT,ASCCODE,DATE,DUDATE,NEXTDATE,INSTNO,ENDOFTERM,ASCADDRESS,PLANTERM,MOD,AMOUNTR,EXPLANDVALUE,SUBAMOUNT,LATECHARGE,ASSADDRESS,AMOUNTWORD,status,mobile,checkby,DATE1,usertype,insttype,userstatus,paidamount,deldate,dptotal,dppaid,dpbal,insttotal,instpaid,instbal,chequebounce,instamtpaid,dppaidamount,totalrec,chequeno,chequenopay,entrytime,discount,discountprice)values('" + TextBox1.Text + "','" + TextBox2.Text + "','" + TextBox3.Text + "','" + TextBox4.Text + "','" + TextBox19.Text + "','" + TextBox20.Text + "','00','" + Label17.Text + "','" + TextBox8.Text + "','" + TextBox17.Text + "','" + TextBox11.Text + "','" + Label11.Text + "'," + Label20.Text + "," + TextBox14.Text + "," + TextBox15.Text + "," + TextBox16.Text + ",'" + TextBox17.Text + "','" + TextBox18.Text + "','PAID','" + Label3.Text + "','" + TextBox5.Text + "','" + date1 + "','" + usertype + "','Installment','Active',0,null,0,0,0,0,0,0," + chequeounce + "," + instpaidamount + "," + dppaidamount + "," + TextBox13.Text + ",'" + Label18.Text + "','" + cheq + "','" + entrytime1 + "','" + rectype + "',"+disprice+")", con1);
            con1.Open();
    ...
    public void latefine()
    {
        SqlConnection con1 = new SqlConnection(s);
        con1.Open();
        SqlDataAdapter da22 = new SqlDataAdapter("select DAY(date3) from  customerreg3 where CUSTREGNO='" + TextBox1.Text + "'", con1);
        DataSet ds22 = new DataSet();
        da22.Fill(ds22);
        con1.Close();
        con1.Open();
        SqlDataAdapter da2 = new SqlDataAdapter("select MONTH(DATE1),Year(DATE1) from recipt3 where CUSTREGNO='" + TextBox1.Text + "' AND DATE1 =(select max(DATE1) from  recipt3 where CUSTREGNO='" + TextBox1.Text + "')", con1);
    ...
    public void checkreg()
    {
        ...
        try
        {
            SqlConnection con1 = new SqlConnection(s);
            con1.Open();
            SqlDataAdapter da = new SqlDataAdapter("select CUSTREGNO,NAMEDOBADDRESS,CONSAMOUNT,PLANANDTERM,EXPIRYDATE,mobile,CHECKBY,DATEOFCOM,APPNO,plotno,regstatus,date3 from customerreg3", con1);
            DataSet ds = new DataSet();
            da.Fill(ds);
            con1.Close();
            ...
            if (ds.Tables[0].Rows.Count > 0)
            {
                ...
                con1.Open();
                SqlDataAdapter da2 = new SqlDataAdapter("select DUDATE from recipt3 where CUSTREGNO='" + TextBox1.Text + "' AND DATE1 =(select max(DATE1) from  recipt3 where CUSTREGNO='" + TextBox1.Text + "')", con1);
                DataSet ds2 = new DataSet();
                da2.Fill(ds2);
                con1.Close();
    ...
    public Double[] paymentsearch()
    {
        ...
        SqlDataAdapter cmd = new SqlDataAdapter("select SUM(instamtpaid),sum(dppaidamount) from recipt3 where CUSTREGNO='" + TextBox1.Text + "'", con1);
        DataSet ds = new DataSet();
        cmd.Fill(ds);
        con1.Close();
        if (ds.Tables[0].Rows.Count > 0)
    ...
    public void instcount()
    {
        ...
        con1.Open();
        SqlDataAdapter da1 = new SqlDataAdapter("select count(INSTNO) from recipt3 where CUSTREGNO='" + TextBox1.Text + "'", con1);
        DataSet ds1 = new DataSet();
        da1.Fill(ds1);
        con1.Close();
    ...
    public int checkpayrecur()
    {
        ...
        con.Open();
        SqlDataAdapter da = new SqlDataAdapter("select count(AMOUNTR) from recipt3 where month(DATE1)=month(getdate()) AND year(DATE1)=year(getdate()) AND CUSTREGNO='" + TextBox1.Text + "'", con);
        DataSet ds = new DataSet();
        da.Fill(ds);
        con.Close();
        if (ds.Tables[0].Rows.Count > 0)
    ...
    {
        SqlConnection con = new SqlConnection(s);
        SqlDataAdapter da = new SqlDataAdapter("select DATEDIFF(MONTH,date3,lastdate),date3 from  customerreg3 where CUSTREGNO='" + TextBox1.Text + "'", con);
        con.Open();
        DataSet ds = new DataSet();
        da.Fill(ds);
        con.Close();
        ...
        SqlDataAdapter da1 = new SqlDataAdapter("select DATEDIFF(MONTH,(select TOP 1 DATE1 from recipt3 where CUSTREGNO='" + TextBox1.Text + "'),(select TOP 1 DATE1 from recipt3 where CUSTREGNO='" + TextBox1.Text + "' ORDER BY DATE1 DESC)) ", con);
        con.Open();
        DataSet ds1 = new DataSet();
        da1.Fill(ds1);
        con.Close();
    ...
    {
       /* SqlConnection con = new SqlConnection(s);
        SqlDataAdapter da = new SqlDataAdapter("select CHEQUENO,CAMOUNT,BSTATUS from  chequedetails where CUSTREGNO='" + TextBox1.Text + "'  AND STATUS='UNPAID'", con);
        con.Open();
        DataSet ds = new DataSet();
        da.Fill(ds);
        con.Close();
        ...
        if (ds.Tables[0].Rows.Count > 0)
        {
            for (int i = 0; i < ds.Tables[0].Rows.Count; i++)
            {
                if (TextBox21.Text == ds.Tables[0].Rows[i][0].ToString())
                {
                    ...
                    bst = ds.Tables[0].Rows[i][2].ToString();
                    break;
                }
            }
            if (rty == 0)
            ...
            else
            {
                if (bst == "BOUNCE")
                {
                    Label24.Text = "CHEQUE FOUND BUT ITS BOUNCE.PLEASE CHANGE CHEQUE STATUS";
    ...
    protected void Button3_Click(object sender, EventArgs e)
    {
        ...
        SqlConnection con = new SqlConnection(s);
       /* SqlCommand cmd1 = new SqlCommand("update chequedetails set BSTATUS='BOUNCE',BDATE='" +date2 + "' where CHEQUENO='" + TextBox21.Text + "' AND CUSTREGNO='" + TextBox1.Text + "'", con);
        con.Open();
        cmd1.ExecuteNonQuery();
        con.Close();*/
        Response.Redirect("https://heedrealestate.com/home/admin.aspx");
    }
}