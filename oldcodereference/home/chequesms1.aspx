<%@ Page Language="C#" AutoEventWireup="true" CodeFile="chequesms1.aspx.cs" Inherits="chequesms" %>
            ...
            <tr>
                ...
                <td class="style3">
                    ...
                    <asp:HyperLink ID="HyperLink1" runat="server" BackColor="Lime" 
                        ...
                        Width="120px" Target="_blank" NavigateUrl="deletecheque.aspx" 
                        Visible="False">Delete Cheque</asp:HyperLink>
                </td>
            </tr>
            <tr>
                <td colspan="3">
                 ...
                 <asp:TemplateField>
                  ...
                  <asp:Label ID="id1278" runat="server" Text='<%# Eval("BDATE","{0:dd, MMM yyyy}") %>'></asp:Label>
                    ...
                    <ItemStyle Width="9%"></ItemStyle>
                                    ...
                                    &nbsp;&nbsp;
                                    <asp:Label ID="Label4889" runat="server" Text="Label" style="color: #FF0000; font-weight: 700;"></asp:Label>
                                    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                    ...
                                    <asp:Button ID="Button11" runat="server" CssClass="ui-priority-primary" 
                                        Height="26px" onclick="Button11_Click" Text="UNLOCK" Visible="False" />
                                </td>
                            </tr>
                            <tr>
                                <td colspan="11">
