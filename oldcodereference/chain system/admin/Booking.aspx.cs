   ...
   string s = ConfigurationManager.ConnectionStrings["amar"].ConnectionString.ToString();
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        else
        {
			...
			{
				Response.Redirect("~/chain system/admin.aspx");
			}
    ...
    public void bindl()
    {
		...
		con.Open();
        SqlDataAdapter da7 = new SqlDataAdapter("select DISTINCT loc from wjstar1.ploted1 where arazino in(select DISTINCT arazi from chainarazi)", con);
        DataSet ds7 = new DataSet();
        da7.Fill(ds7);
        con.Close();
        con.Open();
        SqlDataAdapter da = new SqlDataAdapter("select DISTINCT arazino from wjstar1.ploted1 where arazino in(select DISTINCT arazi from chainarazi)", con);
        DataSet ds = new DataSet();
        da.Fill(ds);
        con.Close();
		
        con.Open();
        SqlDataAdapter da1 = new SqlDataAdapter("select formid,CONCAT(formid,'-->',name) as demo from agent", con);
        ...
        DropDownList4.DataTextField = "demo";
        DropDownList4.DataValueField = "formid";
         ...
         public void fetch()
    {
        ...
        con1.Open();
        int rcid=0;
        SqlCommand cmd = new SqlCommand("select max(ID) from wjstar1.customerreg1",con1);
        ...
        if (dr.HasRows == true)
        {
            ...
            rcid = rcid + 1;
            Label1.Text = "CREG00"+rcid.ToString();
            con1.Close();
        }
         ...
         public Double dppay()
         {
             ...
             if (arazi == "152" || arazi == "506" || arazi == "519" || arazi == "239" || arazi == "161GHA" || arazi == "186MI" || arazi == "RAMAI137" || arazi=="159" || arazi=="1452"  || arazi=="357" || arazi=="217" || arazi=="187-KHA" || arazi=="320" || arazi=="356" || arazi=="353" || arazi=="37 JAJMAU" || arazi=="419" || arazi=="1413"  || arazi=="308" || arazi=="340" || arazi=="1731" || arazi=="246_12BEEGHA")
             {
                 if (TextBox4.Text != "")
                 {
         ...
         protected void Button1_Click(object sender, EventArgs e)
         {
             try
             {
                 if (DropDownList6.Text == "CASH" || DropDownList6.Text == "EMI")
                 {
                     ...
                     SqlConnection con1 = new SqlConnection(s);
                     con1.Open();
                     SqlCommand cmd = new SqlCommand("insert into wjstar1.customerreg1(CUSTREGNO,DATEOFCOM,PLANANDTERM,MODOFPAY,CONSAMOUNT,INSTSUBPAY,SUBDUEDATE,EXPPAY,DATEOFLAST,EXPIRYDATE,AGENCYID,NAMEDOBADDRESS,APPNO,PLOTSIZE,NOMINEESNAME,RECIPTNO,AMOUNTWORD,ESPR,CHECKBY,plotno,mobile,idcard,date3,mobile2,usertype,ragistry,ragistryamt,lastdate,downpay,lockreg,mobile3,agentid,booktype)values('" + Label1.Text + "','" + TextBox1.Text + "','" + DropDownList2.Text + "','" + DropDownList1.Text + "'," + TextBox4.Text + "," + TextBox5.Text + ",'" + TextBox6.Text + "'," + TextBox7.Text + ",'" + TextBox8.Text + "','" + TextBox9.Text + "','" + TextBox10.Text + "','" + TextBox11.Text + "','" + DropDownList3.Text + "'," + TextBox13.Text + ",'" + TextBox14.Text + "','" + TextBox16.Text + "','" + TextBox17.Text + "'," + TextBox15.Text + ",'" + DropDownList4.SelectedValue.ToString() + "','" + plotno + "','" + TextBox3.Text + "','" + TextBox2.Text + "','" + ddd + "','" + TextBox21.Text + "','" + Label4.Text + "',NULL,0,'" + date12 + "'," + totaldppay + ",'UNLOCK','" + TextBox45.Text + "','" + DropDownList4.SelectedValue.ToString() + "','"+DropDownList6.Text+"')", con1);
                     ...
                     if (i == 1)
                     {
                         Label2.Text = "Thank You for New Registration";
                         printreg();
                         plotbook();
                 ...
                 else
                 {
                     ...
                     string message = "Please Select Booking Type";
                     System.Text.StringBuilder sb = new System.Text.StringBuilder();
                     sb.Append("<script type = 'text/javascript'>");
                     sb.Append("window.onload=function(){");
                     sb.Append("alert('");
