...
<tr height="45px"><td colspan="4" style="font-size:20PT;text-align:center;">CHECK PAID INSTALLMENT </td></tr>
 <tr><td style="font-weight:bold;" bgcolor="#CCFF33" colspan="2" rowspan="2">&nbsp;User&nbsp;&nbsp;
     ...
     &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</td><td style="font-weight:bold;" bgcolor="#F0F0F0" colspan="2" 
 ...
 <tr height="45px"><td style="font-weight:bold;" bgcolor="#FFCC99" colspan="2" 
 ...
 <tr height="45px"><td style="font-weight:bold;">DATE FROM</td><td class="style3"><asp:TextBox ID="TextBox1" runat="server" class="d" Height="22px" Width="183px">MM/DD/YY</asp:TextBox></td>
     ...
     <asp:DropDownList ID="DropDownList2" runat="server" Height="23px" Width="134px">
        ...
        <asp:Label ID="Label1" runat="server" Text=""></asp:Label></strong></td></tr>
 <tr><td style="font-weight:bold;" colspan="4" class="style2">
     </td>
