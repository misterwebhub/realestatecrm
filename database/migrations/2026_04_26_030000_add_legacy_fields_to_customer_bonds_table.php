...
return new class extends Migration
{
    ...
    {
        if (! Schema::hasTable('customer_bonds')) {
            return;
        }
        ...
        Schema::table('customer_bonds', function (Blueprint $table) {
            ...
            $table->text('customer_comment')->nullable()->after('broker_comment');
        });
    }
    ...
    public function down(): void
    {
        ...
        Schema::table('customer_bonds', function (Blueprint $table) {
            $table->dropColumn([
                'mobile', 'land_size', 'sale_land', 'sale_rate', 'total_amount', 'bayana_mode', 'bond_type', 'amount', 'balance', 'last_date', 'broker_payment', 'broker_paid', 'broker_balance', 'broker_comment', 'customer_comment',
            ]);

            if (Schema::hasColumn('customer_bonds', 'broker_id')) {
