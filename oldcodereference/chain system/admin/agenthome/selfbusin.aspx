<%@ Page Title="" Language="C#" MasterPageFile="~/admin/agenthome/agentmaster.master" AutoEventWireup="true" CodeFile="selfbusin.aspx.cs" Inherits="admin_agenthome_selfbusin" %>
...
<div class="content-wrapper" style="min-height: 428.016px;">
  ...
  <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h4 class="m-0 text-success font-weight-bold">Direct Business Report 
               </h4>
          </div><!-- /.col -->
    ...
    <asp:TemplateField HeaderText="Book Id">  
                ...
                <asp:TemplateField HeaderText="Agent Name">  
                    <ItemTemplate>  
                        <asp:Label ID="ifsc" runat="server" Text='<%#Eval("name1") %>'></asp:Label>  
                    </ItemTemplate>  
                    <ItemStyle Width="100px" />
                </asp:TemplateField>
