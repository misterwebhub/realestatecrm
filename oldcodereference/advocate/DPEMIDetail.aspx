<%@ Page Language="C#" AutoEventWireup="true" CodeFile="DPEMIDetail.aspx.cs" Inherits="Detail" %>
    ...
    <table class="t">
        <tr class="style22">
            <td class="style33">
                DATE FROM</td>
            <td class="style25">
                <asp:TextBox ID="TextBox1" runat="server"  Height="24px" Width="97px" 
                    ></asp:TextBox>
            </td>
            <td class="style27">
                DATE TO&nbsp;
            ...
            <td class="style29">
                <asp:TextBox ID="TextBox2" runat="server"  Height="24px" Width="105px" 
                   ></asp:TextBox>
            </td>
            <td class="style35">
