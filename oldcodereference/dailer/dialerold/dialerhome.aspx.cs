...
public partial class dialer_dialerhome : System.Web.UI.Page
{
     ...
     */
           ...
           string callid1="";
            ...
            SqlCommand cmd = new SqlCommand("insert into callerfeedback(date,reason,CUSTREGNO,feeddate,userid,entrytime,callid,entrytime1)values('" + ddd + "','" + TextBox1111.Text + "','" + Label1111.Text + "','" + start + "','" + Label4444.Text + "','" + tm + "','"+callid1+"','" + tm + "')", con1);
            con1.Open();
            ...
            if (y != 0)
            {
                ...
                if (de != 0)
                {
					...
					tm=DateTime.Now.ToString("h:mm:ss tt");
                    SqlCommand cmd3 = new SqlCommand("update calldemo set date='" + ddd3 + "',reason='" + TextBox1111.Text + "',feeddate='" + start + "',entrytime='" + tm + "',callid='"+callid1+"',entrytime1='" + tm + "' where CUSTREGNO='" + Label1111.Text + "'", con1);
                    con1.Open();
                ...
                else
                {
					...
					tm=DateTime.Now.ToString("h:mm:ss tt");
                    SqlCommand cmd3 = new SqlCommand("insert into calldemo(date,reason,CUSTREGNO,feeddate,userid,entrytime,callid,entrytime1)values('" + ddd3 + "','" + TextBox1111.Text + "','" + Label1111.Text + "','" + start + "','" + Label4444.Text + "','" + tm + "','"+callid1+"','" + tm + "')", con1);
                    con1.Open();
                    cmd3.ExecuteNonQuery();
                    con1.Close();
                }
