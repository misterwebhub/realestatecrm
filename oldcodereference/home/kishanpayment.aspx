<%@ Page Language="C#" AutoEventWireup="true" CodeFile="kishanpayment.aspx.cs" Inherits="kishanpayment" %>
   ...
   <div style="height:550px;width:100%;">
    <div id="r" class="p">
        ...
        <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" 
            ...
            CellPadding="3" DataKeyNames="id" Font-Size="10pt" GridLines="Vertical" 
        ...
        <table height="80%" width="100%" style="font-size:12pt;">
            <tr>
                <td class="style2" colspan="8" style="text-align: center" bgcolor="#000066">
                    <strong>Kishan Recipt&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; Recipt- </strong>
                    <asp:Label ID="Label14" runat="server" style="font-weight: 700" Text=""></asp:Label>
                </td>
            </tr>
            <tr>
            ...
            <tr>
                ...
                <td class="style72" bgcolor="#FFCCFF">
                    PAID AMT</td>
                <td class="style62" bgcolor="#FFCCFF">
                    <asp:Label ID="Label6" runat="server" Text="Label"></asp:Label>
                </td>
                <td class="style74" bgcolor="#FFCCFF">
                    BALANCE AMT</td>
                <td class="style64" bgcolor="#FFCCFF">
                    <asp:Label ID="Label7" runat="server" Text="Label"></asp:Label>
                </td>
                <td class="style65" bgcolor="#FFCCFF">
                    <strong>UNPAID CHEQUE</strong></td>
            ...
            <tr>
                ...
                <td class="style32" bgcolor="#FFCCFF">
                    <asp:TextBox ID="TextBox1" runat="server" Height="25px" Width="97px" 
                        AutoPostBack="True" ontextchanged="TextBox1_TextChanged">0</asp:TextBox>
                    </td>
    ...
    <div id="r" class="p1">
        <table height="80%" width="100%" style="font-size:12pt;">
            <tr>
                <td class="style2" colspan="8" style="text-align: center" bgcolor="#000066">
                    <strong>Invester Recipt&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; Recipt- </strong>
            ...
            <tr>
                ...
                <td class="style128" bgcolor="#FFCCFF">
                    RECV AMT.</td>
                <td class="style64" bgcolor="#FFCCFF">
            ...
            <tr>
                ...
                <td class="style131" bgcolor="#FFCCFF">
                    <strong>AMOUNT</strong></td>
                <td class="style32" bgcolor="#FFCCFF">
                    <asp:TextBox ID="TextBox16" runat="server" Height="25px" Width="97px" 
                        ontextchanged="TextBox16_TextChanged" AutoPostBack="True">0</asp:TextBox>
                    </td>
            ...
            <tr>
                ...
                <td class="style135" bgcolor="#FFCCFF">
                    <asp:Button ID="Button4" runat="server" onclick="Button4_Click" Text="new" />
                </td>
                <td bgcolor="#FFCCFF">
                    &nbsp;</td>
            </tr>
    ...
    <div id="r" class="p">
        <asp:GridView ID="GridView2" runat="server" AutoGenerateColumns="False" 
            BackColor="White" BorderColor="#999999" BorderStyle="None" BorderWidth="1px" 
            CellPadding="3" DataKeyNames="bregno" Font-Size="10pt" GridLines="Vertical" 
            Width="100%" onrowcommand="GridView2_RowCommand" 
            >
            <AlternatingRowStyle BackColor="#DCDCDC" />
            <Columns>
                <asp:BoundField DataField="bregno" HeaderText="ID" />
