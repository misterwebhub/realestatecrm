...
public partial class userreciptdetails : System.Web.UI.Page
{
    ...
    protected void Button1_Click(object sender, EventArgs e)
    {
        try
        {
            ...
            SqlDataAdapter da = new SqlDataAdapter("select r.CUSTREGNO,SUBSTRING(r.ASCADDRESS,1,15) AS 'NAME',r.RECIPT,r.DATE1 AS 'DATE',r.entrytime AS 'TIME',r.INSTNO,r.chequenopay AS 'che',r.AMOUNTR AS 'AMOUNT',r.dppaidamount,r.instamtpaid,r.LATECHARGE,r.chequebounce,r.checkby AS 'CHECKBY',r.usertype AS 'USER',u.APPNO AS 'ARAZI',u.plotno AS 'PLOT',u.PLOTSIZE AS 'SIZE',r.userstatus,r.paidamount,r.deldate,u.date3 from  recipt3 r  LEFT JOIN customerreg3 u ON r.CUSTREGNO=u.CUSTREGNO where (r.DATE1 BETWEEN '" + date1 + "' AND '" + date2 + "') AND r.usertype='" + DropDownList1.Text + "'  AND r.RECIPT NOT IN(9758,9708,9358,8936)  ORDER BY r.RECIPT ASC", con1);
            DataSet ds = new DataSet();
           da.Fill(ds);
           con1.Close();
           con1.Open();
           SqlDataAdapter da2 = new SqlDataAdapter("select r.CUSTREGNO,SUBSTRING(r.ASCADDRESS,1,15) AS 'NAME',r.RECIPT,r.DATE1 AS 'DATE',r.INSTNO,r.chequenopay AS 'che',r.AMOUNTR AS 'AMOUNT',r.checkby AS 'CHECKBY',r.usertype AS 'USER',u.APPNO AS 'ARAZI',u.plotno AS 'PLOT',u.PLOTSIZE AS 'SIZE',r.userstatus,r.paidamount,r.deldate,u.date3 from  recipt3 r LEFT JOIN customerreg3 u ON r.CUSTREGNO=u.CUSTREGNO where  r.usertype='" + DropDownList1.Text + "' AND (r.deldate BETWEEN '" + date1 + "' AND '" + date2 + "') AND  r.CUSTREGNO NOT IN(select CUSTREGNO from  recipt3 where r.deldate=r.DATE1)", con1);
           DataSet ds2 = new DataSet();
           da2.Fill(ds2);
           con1.Close();
           con1.Open();
           SqlDataAdapter da22 = new SqlDataAdapter("select sum(r.paidamount) from  recipt3 r LEFT JOIN customerreg3 u ON r.CUSTREGNO=u.CUSTREGNO where (r.deldate BETWEEN '" + date1 + "' AND '" + date2 + "') AND r.usertype='" + DropDownList1.Text + "'  AND r.CUSTREGNO NOT IN(select CUSTREGNO from  recipt3 where MONTH(r.deldate)=MONTH(r.DATE1) AND YEAR(r.deldate)=YEAR(r.DATE1))", con1);
           ...
           con1.Open();
           SqlDataAdapter da223 = new SqlDataAdapter("select sum(r.paidamount) from  recipt3 r LEFT JOIN customerreg3 u ON r.CUSTREGNO=u.CUSTREGNO where (r.DATE1 BETWEEN '" + date1 + "' AND '" + date2 + "') AND r.usertype='" + DropDownList1.Text + "' AND r.userstatus='Inactive'", con1);
           ...
           SqlDataAdapter da1 = new SqlDataAdapter("select sum(r.AMOUNTR) AS 'AMOUNT',sum(r.LATECHARGE)+sum(r.chequebounce) AS 'FINE' from  recipt3 r LEFT JOIN customerreg3 u ON r.CUSTREGNO=u.CUSTREGNO where (r.DATE1 BETWEEN '" + date1 + "' AND '" + date2 + "') AND r.usertype='" + DropDownList1.Text + "' AND r.RECIPT NOT IN(9758,9708) ", con1);
           DataSet ds1 = new DataSet();
           da1.Fill(ds1);
           con1.Close();
           ...
           // Label3.Text = ds2.Tables[0].Rows[0][0].ToString();
            ...
            {
                d2 = Convert.ToDouble(ds1.Tables[0].Rows[0][0].ToString());
            }
            else
            {
                d2 = 0;
            ...
            {
                fine = Convert.ToDouble(ds1.Tables[0].Rows[0][1].ToString());
            }
            else
            {
                fine = 0;
    ...
    protected void Button2_Click(object sender, EventArgs e)
    {
        try
        {
            ...
            SqlDataAdapter da = new SqlDataAdapter("select r.CUSTREGNO,SUBSTRING(r.ASCADDRESS,1,15) AS 'NAME',r.RECIPT,r.DATE1 AS 'DATE',r.entrytime AS 'TIME',r.INSTNO,r.chequenopay AS 'che',r.AMOUNTR AS 'AMOUNT',r.dppaidamount,r.instamtpaid,r.LATECHARGE,r.chequebounce,r.checkby AS 'CHECKBY',r.usertype AS 'USER',u.APPNO AS 'ARAZI',u.plotno AS 'PLOT',u.PLOTSIZE AS 'SIZE',r.userstatus,r.paidamount,r.deldate,u.date3 from  recipt3 r LEFT JOIN customerreg3 u ON r.CUSTREGNO=u.CUSTREGNO where (r.DATE1 BETWEEN '" + date1 + "' AND '" + date2 + "')  AND r.RECIPT NOT IN(9758,9708,9358,8936) ORDER BY r.RECIPT", con1);
            DataSet ds = new DataSet();
            da.Fill(ds);
            con1.Close();
            con1.Open();
            SqlDataAdapter da2 = new SqlDataAdapter("select r.CUSTREGNO,SUBSTRING(r.ASCADDRESS,1,15) AS 'NAME',r.RECIPT,r.DATE1 AS 'DATE',r.INSTNO,r.chequenopay AS 'che',r.AMOUNTR AS 'AMOUNT',r.checkby AS 'CHECKBY',r.usertype AS 'USER',u.APPNO AS 'ARAZI',u.plotno AS 'PLOT',u.PLOTSIZE AS 'SIZE',r.userstatus,r.paidamount,r.deldate,u.date3 from  recipt3 r LEFT JOIN customerreg3 u ON r.CUSTREGNO=u.CUSTREGNO where  (r.deldate BETWEEN '" + date1 + "' AND '" + date2 + "') AND  r.CUSTREGNO NOT IN(select CUSTREGNO from  recipt3 where r.deldate=r.DATE1)", con1);
            DataSet ds2 = new DataSet();
            da2.Fill(ds2);
            con1.Close();
            con1.Open();
            SqlDataAdapter da22 = new SqlDataAdapter("select sum(r.paidamount) from  recipt3 r LEFT JOIN customerreg3 u ON r.CUSTREGNO=u.CUSTREGNO where  (r.deldate BETWEEN '" + date1 + "' AND '" + date2 + "') AND  r.CUSTREGNO NOT IN(select CUSTREGNO from  recipt3 where r.deldate=r.DATE1)", con1);
            DataSet ds22 = new DataSet();
            da22.Fill(ds22);
            con1.Close();
            Double backamount = 0;
            ...
            con1.Open();
            SqlDataAdapter da223 = new SqlDataAdapter("select sum(r.paidamount) from  recipt3 r LEFT JOIN customerreg3 u ON r.CUSTREGNO=u.CUSTREGNO where (r.DATE1 BETWEEN '" + date1 + "' AND '" + date2 + "') AND r.userstatus='Inactive'", con1);
            DataSet ds223 = new DataSet();
            da223.Fill(ds223);
            con1.Close();
            Double curamount = 0;
            ...
            SqlDataAdapter da1 = new SqlDataAdapter("select sum(r.AMOUNTR) AS 'AMOUNT',sum(r.LATECHARGE)+sum(r.chequebounce) AS 'FINE' from  recipt3 r LEFT JOIN customerreg3 u ON r.CUSTREGNO=u.CUSTREGNO where (r.DATE1 BETWEEN '" + date1 + "' AND '" + date2 + "')  AND r.RECIPT NOT IN(9758,9708) ", con1);
            DataSet ds1 = new DataSet();
            da1.Fill(ds1);
            con1.Close();
   ...
   public static int d = 0;
    protected void Button3_Click(object sender, EventArgs e)
    {
        ...
        try
        {
            ...
            SqlDataAdapter da = new SqlDataAdapter("select r.CUSTREGNO,SUBSTRING(r.ASCADDRESS,1,15) AS 'NAME',r.RECIPT,r.DATE1 AS 'DATE',r.INSTNO,r.chequenopay AS 'che',r.AMOUNTR AS 'AMOUNT',r.dppaidamount,r.instamtpaid,r.LATECHARGE,r.chequebounce,r.checkby AS 'CHECKBY',r.usertype AS 'USER',u.APPNO AS 'ARAZI',u.plotno AS 'PLOT',u.PLOTSIZE AS 'SIZE',r.userstatus,r.paidamount,r.deldate,u.date3 from  recipt3 r LEFT JOIN customerreg3 u ON r.CUSTREGNO=u.CUSTREGNO where r.DATE1 = '" + date1 + "'", con1);
            DataSet ds = new DataSet();
            da.Fill(ds);
            con1.Close();
            con1.Open();

            SqlDataAdapter da1 = new SqlDataAdapter("select sum(r.AMOUNTR) AS 'AMOUNT' from  recipt3 r LEFT JOIN customerreg3 u ON r.CUSTREGNO=u.CUSTREGNO where r.DATE1='" + date1 + "'", con1);
            DataSet ds1 = new DataSet();
            da1.Fill(ds1);
 ...
 e.Row.Cells[2].ForeColor = System.Drawing.Color.Blue;
    ...
    public Double[] recamtpayment(string reg,Double tdp,Double tins,Double bal)
    {
           ...
           SqlDataAdapter cmd = new SqlDataAdapter("select SUM(dppaidamount) from recipt3 where CUSTREGNO='" + reg + "'", con1);
            DataSet ds = new DataSet();
            cmd.Fill(ds);
            con1.Close();
            con1.Open();
            SqlDataAdapter cmd1 = new SqlDataAdapter("select SUM(instamtpaid) from recipt3 where CUSTREGNO='" + reg + "'", con1);
            DataSet ds1 = new DataSet();
            cmd1.Fill(ds1);
            con1.Close();
            if (ds.Tables[0].Rows[0][0].ToString() != "")
    ...
    public Double[] amountbal(Double instbalrec, String reg, Double instbalance, Double bal1)
    {
       ...
       // Label21.Text = paodbalinst.ToString("N2");
        SqlDataAdapter da1 = new SqlDataAdapter("select DATEDIFF(MONTH,(select TOP 1 DATE1 from recipt3 where CUSTREGNO='" + reg + "'),(select TOP 1 DATE1 from recipt3 where CUSTREGNO='" + reg + "' ORDER BY DATE1 DESC)) ", con);
        con.Open();
        DataSet ds1 = new DataSet();
        da1.Fill(ds1);
        con.Close();
    ...
    protected void OnRowCommand(object sender, GridViewCommandEventArgs e)
    {
       ...
       // Label10.Text = reg;
        ...
        SqlDataAdapter da = new SqlDataAdapter("select CUSTREGNO,APPNO,CONSAMOUNT from  customerreg3 where CUSTREGNO='" + reg + "'", con1);
        DataSet ds = new DataSet();
        da.Fill(ds);
        con1.Close();
        ...
        Double amt = 0;
        SqlDataAdapter cmd1 = new SqlDataAdapter("select SUM(AMOUNTR) from recipt3 where CUSTREGNO='" + reg + "'", con1);
        DataSet ds1 = new DataSet();
        cmd1.Fill(ds1);
        con1.Close();
   ...
   this.GetType(), "OpenWindow", "window.open('customerdetails1.aspx','_newtab');", true);
