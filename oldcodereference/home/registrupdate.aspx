<%@ Page Language="C#" AutoEventWireup="true" CodeFile="registrupdate.aspx.cs" Inherits="registr" %>
           ...
           <tr><td></td><td>
            ...
            <tr>
                <td class="style5" colspan="4">
                    &nbsp;
                    REG.NO-
                    <asp:TextBox ID="TextBox78" runat="server" Height="25px" Width="96px"></asp:TextBox>
                    &nbsp;&nbsp;&nbsp;&nbsp;
                    <asp:Button ID="Button19" runat="server" Text="SEARCH" 
                        onclick="Button19_Click" />
                    &nbsp;&nbsp;
                    <asp:Label ID="Label25" runat="server" style="color: #FF0000; font-weight: 700" 
...
&nbsp;&nbsp;&nbsp;
            ...
            <tr>
                ...
                <td class="style35" colspan="3">
                    <asp:TextBox ID="TextBox14" runat="server" Height="58px" Width="537px" 
            ...
            <tr>
                ...
                <td class="style4" colspan="3">
                    <asp:TextBox ID="TextBox15" runat="server" Height="53px" Width="537px" 
                        TextMode="MultiLine"></asp:TextBox>
                </td>
            </tr>
				 <tr> <td class="style6">
                    Status Change</td>
                <td class="style6">
                   <asp:DropDownList ID="DropDownList113" runat="server" Height="18px" Width="98px">
            ...
            <tr>
                ...
                <td class="style4" colspan="2">
                    <asp:Button ID="Button1" runat="server" Text="UPDATE" Width="269px" 
                ...
                <td class="style7">
                    <asp:Button ID="Button20" runat="server" onclick="Button20_Click" 
                        style="font-weight: 700" Text="DELETE" Width="76px" />
                </td>
                <td class="style7">
                    &nbsp;</td>
            </tr>
        ...
        <div id="countrytabs-2">
            ...
            <tr>
                <td class="style52" colspan="4">
                    &nbsp;
                    REG.NO-
                    <asp:TextBox ID="TextBox79" runat="server" Height="27px" Width="91px"></asp:TextBox>
                    &nbsp;&nbsp;&nbsp;
                    <asp:Button ID="Button21" runat="server" onclick="Button21_Click" 
                        style="font-weight: 700" Text="SEARCH" />
                    &nbsp;&nbsp;
                    <asp:Label ID="Label26" runat="server" style="color: #FF0000; font-weight: 700"></asp:Label>
                </td>
            </tr>
            <tr>
                <td class="style10">
...
&nbsp;&nbsp;&nbsp;
            ...
            <tr>
                <td class="style9">
                    Status Change</td>
                <td class="style59">
                   <asp:DropDownList ID="DropDownList11" runat="server" Height="18px" Width="98px">
            <asp:ListItem>--select---</asp:ListItem>
					    <asp:ListItem>currently</asp:ListItem>
            <asp:ListItem>completed</asp:ListItem>
        </asp:DropDownList></td>
                <td class="style7">
                 <asp:Button ID="Button5" runat="server" BackColor="#003366" Height="26px" 
            style="color: #FFFFFF; font-weight: 700" Text="Change Status" onclick="Button5_Click" /></td>
                <td class="style72">
                    &nbsp;</td>
                <td class="style7">
                    &nbsp;</td>
                ...
                <td class="style9">
                   Monthly Payment</td>
                <td class="style59">
                   <asp:TextBox ID="TextBox482" runat="server" ></asp:TextBox></td>
                <td class="style7">
                &nbsp;  </td>
                <td class="style72">
                    &nbsp;</td>
            ...
            <tr>
                ...
                <td class="style4" colspan="2">
                    <asp:Button ID="Button16" runat="server" Height="28px" onclick="Button16_Click" 
                        style="font-weight: 700" Text="UPDATE" Width="248px" />
                </td>
                <td class="style72">
                    <asp:Label ID="Label17" runat="server" style="color: #FF0000; font-weight: 700"></asp:Label>
                </td>
                <td class="style7">
                    <asp:Button ID="Button22" runat="server" Height="26px" onclick="Button22_Click" 
                        style="font-weight: 700" Text="DELETE" Width="70px" />
                </td>
                <td class="style7">
                    &nbsp;</td>
            </tr>
