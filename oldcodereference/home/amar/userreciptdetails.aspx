...
&nbsp;<asp:Label ID="Label7" runat="server" Text="RECIEVE DATE" 
                    ...
                    <asp:GridView ID="GridView1" runat="server" BackColor="White" 
                        ...
                        <Columns>
                        <asp:TemplateField ItemStyle-Width = "30px"  HeaderText = "CUSTREGNO"><ItemTemplate>
       <asp:LinkButton ID="lnkEdit" runat="server" Text = "Select" OnClick = "Edit"></asp:LinkButton>
   </ItemTemplate>
</asp:TemplateField>
                            <asp:BoundField DataField="CUSTREGNO" HeaderText="CUSTREG.NO" />
                            <asp:BoundField DataField="date3" HeaderText="BOOKING DATE" DataFormatString = "{0:dd/MM/yyyy}"/>
    ...
    <tr>
    <td style="width:90%;height:10%;" colspan="5"><p style="font-size:x-large;text-align:center;" >Customer Details</p></td>

    <td style="width:10%;"><asp:Button ID="btnCancel" runat="server" Text="X" BackColor="Black" ForeColor="White" OnClientClick = "return Hidepopup()"/></td>

</tr>
<tr><td style="width:20%;">Customer Reg. No.</td><td colspan="5" style="width:60%;"><asp:Label ID = "Label10" runat = "server" Text = "" ForeColor="Green" Font-Bold="true"></asp:Label></td></tr>
<tr><td>Arazi</td><td>
    <asp:Label ID="Label11" runat="server" Text="" ForeColor="Red" Font-Bold="true"></asp:Label></td><td>Fixed Inst.</td><td>
    <asp:Label ID="Label21" runat="server" Text="" ForeColor="Red" Font-Bold="true"></asp:Label></td><td>Current Inst.</td><td>
    <asp:Label ID="Label22" runat="server" Text="" ForeColor="Red" Font-Bold="true"></asp:Label></td></tr>
<tr><td>Total Payment</td><td><asp:Label ID="Label12" runat="server" Text="0" ForeColor="Green" Font-Bold="true"></asp:Label></td><td>Total Recieve</td><td><asp:Label ID="Label20" runat="server" Text="0" ForeColor="Blue" Font-Bold="true"></asp:Label></td><td>Total Balance</td><td><asp:Label ID="Label19" runat="server" Text="0" ForeColor="Red" Font-Bold="true"></asp:Label></td></tr>
<tr><td>Total D.P</td><td><asp:Label ID="Label13" runat="server" Text="0" ForeColor="Green" Font-Bold="true"></asp:Label></td>
<td> D.P Received </td><td><asp:Label ID="Label14" runat="server" Text="0" ForeColor="Blue" Font-Bold="true"></asp:Label></td>
<td>D.P Balance</td><td><asp:Label ID="Label15" runat="server" Text="0" ForeColor="Red" Font-Bold="true"></asp:Label></td></tr>
<tr><td>Total Installment</td><td><asp:Label ID="Label16" runat="server" Text="0" ForeColor="Green" Font-Bold="true"></asp:Label></td>
<td>Installment Received </td><td><asp:Label ID="Label17" runat="server" Text="0" ForeColor="Blue" Font-Bold="true"></asp:Label></td>
<td>Installment Balance</td><td><asp:Label ID="Label18" runat="server" Text="0" ForeColor="Red" Font-Bold="true"></asp:Label></td></tr>
