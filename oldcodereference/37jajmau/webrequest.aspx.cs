...
public partial class webrequest : System.Web.UI.Page
{
    ...
    {
        // The Next method includes the lower bound (10000) but excludes the upper bound (100000)
    ...
    /*   DateTime r = DateTime.Now;
        ...
        con.Open();
         SqlDataAdapter da = new SqlDataAdapter("select arazi,refno,left(cheqdate,10),kpaidamt,cheqno from kishanrecipt where cheqdate between '" + p + "' and '" + n + "' and status='UNPAID' ORDER BY date ASC", con);
       ...
       String data = "",m="";
        ...
        {*/
       int er = GenerateRandomFiveDigitNumber();
       String data = er.ToString();
    ...
    public static string SendSMS(string msg)
    {
        ...
        string mobileNumber = "9696446268";
        //Sender ID,While using route4 sender id should be 6 characters long.  
        string senderId = "HEEDKP";
        //Your message to send, Add URL encoding here.  
        string msg1 = " Dear Heed Real , Your OTP for login to Web Server is " + msg + ". Valid for 30 minnutes.Please do not Share this OTP . ";
        string message = HttpUtility.UrlEncode(msg1);
        string dlt = "1207176789749731154";
        string route = "4";
        string country = "91";
