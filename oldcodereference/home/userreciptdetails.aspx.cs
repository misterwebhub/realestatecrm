...
public partial class userreciptdetails : System.Web.UI.Page
{
    ...
    public void extra()
    {
        ...
        SqlDataAdapter da = new SqlDataAdapter("select ID,date,class1,name,mode1,number1,amount,reason from extrapaymentexp where date between '" + start + "' AND '" + start1 + "' ", con);
        con.Open();
        DataSet ds = new DataSet();
        da.Fill(ds);
        con.Close();
        SqlDataAdapter da1 = new SqlDataAdapter("select sum(amount) from extrapaymentexp where date between '" + start + "' AND '" + start1 + "' ", con);
        con.Open();
        DataSet ds1 = new DataSet();
        da1.Fill(ds1);
        con.Close();
        ...
        if (ds1.Tables[0].Rows.Count > 0)
        {
            if (ds1.Tables[0].Rows[0][0].ToString() != "")
            {
                ...
                Label12.Text = ds1.Tables[0].Rows[0][0].ToString();
            }
            else
            {
                Label11.Text = "";
        ...
        Double t3 = 0, t10 = 0, t12 = 0, t13 = 0;
        if (Label3.Text != "")
        {
            t3 = Convert.ToDouble(Label3.Text); ;
        }
        else
        {
            t3 = 0;
        ...
        if (Label10.Text != "")
        {
            t10=Convert.ToDouble(Label10.Text);
        }
        else
        {
            t10 = 0;
        ...
        if (Label12.Text != "")
        {
            t12 = Convert.ToDouble(Label12.Text);
        }
        else
        {
            t12 = 0;
    ...
    protected void Button1_Click(object sender, EventArgs e)
    {
        try
        {
            ...
            SqlDataAdapter da = new SqlDataAdapter("select r.CUSTREGNO,SUBSTRING(r.ASCADDRESS,1,15) AS 'NAME',r.RECIPT,r.DATE1 AS 'DATE',r.entrytime AS 'TIME',r.INSTNO,r.chequenopay AS 'che',r.AMOUNTR AS 'AMOUNT',r.dppaidamount,r.instamtpaid,r.LATECHARGE,r.chequebounce,r.checkby AS 'CHECKBY',r.usertype AS 'USER',u.APPNO AS 'ARAZI',u.plotno AS 'PLOT',u.PLOTSIZE AS 'SIZE',r.userstatus,r.paidamount,r.deldate,u.date3,r.payto from  wjstar1.recipt1 r  LEFT JOIN wjstar1.customerreg1 u ON r.CUSTREGNO=u.CUSTREGNO where (r.DATE1 BETWEEN '" + date1 + "' AND '" + date2 + "') AND r.usertype='" + DropDownList1.Text + "'  AND r.RECIPT NOT IN(9758,9708,9358,8936)  ORDER BY r.RECIPT ASC", con1);
            DataSet ds = new DataSet();
           da.Fill(ds);
           con1.Close();
           con1.Open();
           SqlDataAdapter da2 = new SqlDataAdapter("select r.CUSTREGNO,SUBSTRING(r.ASCADDRESS,1,15) AS 'NAME',r.RECIPT,r.DATE1 AS 'DATE',r.INSTNO,r.chequenopay AS 'che',r.AMOUNTR AS 'AMOUNT',r.checkby AS 'CHECKBY',r.usertype AS 'USER',u.APPNO AS 'ARAZI',u.plotno AS 'PLOT',u.PLOTSIZE AS 'SIZE',r.userstatus,r.paidamount,r.deldate,u.date3,r.payto from  wjstar1.recipt1 r LEFT JOIN wjstar1.customerreg1 u ON r.CUSTREGNO=u.CUSTREGNO where  r.usertype='" + DropDownList1.Text + "' AND (r.deldate BETWEEN '" + date1 + "' AND '" + date2 + "') AND  r.CUSTREGNO NOT IN(select CUSTREGNO from  wjstar1.recipt1 where r.deldate=r.DATE1)", con1);
           DataSet ds2 = new DataSet();
           da2.Fill(ds2);
           con1.Close();
           con1.Open();
           SqlDataAdapter da22 = new SqlDataAdapter("select sum(r.paidamount) from  wjstar1.recipt1 r LEFT JOIN wjstar1.customerreg1 u ON r.CUSTREGNO=u.CUSTREGNO where (r.deldate BETWEEN '" + date1 + "' AND '" + date2 + "') AND r.usertype='" + DropDownList1.Text + "'  AND r.CUSTREGNO NOT IN(select CUSTREGNO from  wjstar1.recipt1 where MONTH(r.deldate)=MONTH(r.DATE1) AND YEAR(r.deldate)=YEAR(r.DATE1))", con1);
           ...
           SqlDataAdapter da1 = new SqlDataAdapter("select sum(r.AMOUNTR) AS 'AMOUNT',sum(r.LATECHARGE)+sum(r.chequebounce) AS 'FINE' from  wjstar1.recipt1 r LEFT JOIN wjstar1.customerreg1 u ON r.CUSTREGNO=u.CUSTREGNO where (r.DATE1 BETWEEN '" + date1 + "' AND '" + date2 + "') AND r.usertype='" + DropDownList1.Text + "' AND r.RECIPT NOT IN(9758,9708) ", con1);
           DataSet ds1 = new DataSet();
           da1.Fill(ds1);
           con1.Close();
    ...
    protected void Button2_Click(object sender, EventArgs e)
    {
        try
        {
            ...
            SqlDataAdapter da = new SqlDataAdapter("select r.CUSTREGNO,SUBSTRING(r.ASCADDRESS,1,15) AS 'NAME',r.RECIPT,r.DATE1 AS 'DATE',r.entrytime AS 'TIME',r.INSTNO,r.chequenopay AS 'che',r.AMOUNTR AS 'AMOUNT',r.dppaidamount,r.instamtpaid,r.LATECHARGE,r.chequebounce,r.checkby AS 'CHECKBY',r.usertype AS 'USER',u.APPNO AS 'ARAZI',u.plotno AS 'PLOT',u.PLOTSIZE AS 'SIZE',r.userstatus,r.paidamount,r.deldate,u.date3,r.payto from  wjstar1.recipt1 r LEFT JOIN wjstar1.customerreg1 u ON r.CUSTREGNO=u.CUSTREGNO where (r.DATE1 BETWEEN '" + date1 + "' AND '" + date2 + "')  AND r.RECIPT NOT IN(9758,9708,9358,8936) ORDER BY r.RECIPT", con1);
            DataSet ds = new DataSet();
            da.Fill(ds);
            con1.Close();
            con1.Open();
            SqlDataAdapter da2 = new SqlDataAdapter("select r.CUSTREGNO,SUBSTRING(r.ASCADDRESS,1,15) AS 'NAME',r.RECIPT,r.DATE1 AS 'DATE',r.INSTNO,r.chequenopay AS 'che',r.AMOUNTR AS 'AMOUNT',r.checkby AS 'CHECKBY',r.usertype AS 'USER',u.APPNO AS 'ARAZI',u.plotno AS 'PLOT',u.PLOTSIZE AS 'SIZE',r.userstatus,r.paidamount,r.deldate,u.date3,r.payto from  wjstar1.recipt1 r LEFT JOIN wjstar1.customerreg1 u ON r.CUSTREGNO=u.CUSTREGNO where  (r.deldate BETWEEN '" + date1 + "' AND '" + date2 + "') AND  r.CUSTREGNO NOT IN(select CUSTREGNO from  wjstar1.recipt1 where r.deldate=r.DATE1)", con1);
            DataSet ds2 = new DataSet();
            da2.Fill(ds2);
            con1.Close();
            con1.Open();
            ...
            SqlDataAdapter da1 = new SqlDataAdapter("select sum(r.AMOUNTR) AS 'AMOUNT',sum(r.LATECHARGE)+sum(r.chequebounce) AS 'FINE' from  wjstar1.recipt1 r LEFT JOIN wjstar1.customerreg1 u ON r.CUSTREGNO=u.CUSTREGNO where (r.DATE1 BETWEEN '" + date1 + "' AND '" + date2 + "')  AND r.RECIPT NOT IN(9758,9708) ", con1);
            DataSet ds1 = new DataSet();
            da1.Fill(ds1);
            con1.Close();
    ...
    protected void Button5_Click(object sender, EventArgs e)
    {
        try
        {
           ...
           // Label3.Text = "";
            ...
            SqlConnection con1 = new SqlConnection(s);
            con1.Open();
            SqlCommand cmd = new SqlCommand("insert into userreciveamount(username,datefrom,dateto,recamount,recdate,reason)values('" + DropDownList1.Text + "','" + date1 + "','" + date2 + "'," + TextBox3.Text + ",'" + date3 + "','"+TextBox56.Text+"')", con1);
