<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Booking.aspx.cs" Inherits="regcertificate" %>
	...
	<tr>
		<table>
		  ...
		  <tr>
			...
			<td>
                <asp:DropDownList ID="DropDownList6" runat="server" Height="20px" Width="146px">
                    <asp:ListItem>---select---</asp:ListItem>
	...
	<tr>
		<table>
			...
			<tr>
				...
				<td style="width:25%;text-align:left;">For<asp:TextBox ID="TextBox10" runat="server" name="" class="textboxmain" 
