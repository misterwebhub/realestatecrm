<%@ Page Title="" Language="C#" MasterPageFile="MasterPage.master" AutoEventWireup="true" CodeFile="Exppay.aspx.cs" Inherits="arazi3435_menu1" %>
        ...
        <table class="style1">
            <tr>
                <td class="style2" colspan="4" style="text-align: center">
                    <strong>EXPENSE PAYMENT ENTRY</strong></td>
            </tr>
			<tr>
                <td class="style4">
                    DATE</td>
...
&nbsp;&nbsp;&nbsp;
                    <asp:Button ID="Button2" runat="server" style="font-weight: 700" 
                        Text="DEL" Height="26px" onclick="Button2_Click" />
                </td>
                <td class="style5">
                </td>
            </tr>
            ...
            <tr>
                <td class="style8" colspan="4">
                    ...
                    TOTAL EXTRA PAYMENT EXPENSE OF CURRENT MONTH : -- &gt;&nbsp;&nbsp; </strong>&nbsp; </span>
