...
public partial class Detail : System.Web.UI.Page
{
    ...
    public void allpaid(String user1)
    {
        ...
        SqlDataAdapter cmd = new SqlDataAdapter("select DISTINCT CUSTREGNO,LEFT(ASCADDRESS,20) AS 'ASCADDRESS',AMOUNTR,DATE1,checkby from wjstar1.recipt1 where status='PAID' AND usertype='"+user1+"' AND (DATE1 BETWEEN '" + date1 + "' AND '" + date2 + "') AND (CUSTREGNO IN (select DISTINCT CUSTREGNO from wjstar1.customerreg1 where  CUSTREGNO NOT IN(Select DISTINCT CUSTREGNO from wjstar1.customerreg1 where  regstatus='Cancel'))) order by DATE1 ASC", con1);
       ...
       // GridView1.DataBind();
        ...
        SqlDataAdapter cmd1 = new SqlDataAdapter("select sum(AMOUNTR) from wjstar1.recipt1 where status='PAID' AND usertype='" + user1 + "' AND (DATE1 BETWEEN '" + date1 + "' AND '" + date2 + "') AND (CUSTREGNO IN (select DISTINCT CUSTREGNO from wjstar1.customerreg1 where  CUSTREGNO NOT IN(Select DISTINCT CUSTREGNO from wjstar1.customerreg1 where  regstatus='Cancel')))", con2);
        DataSet ds1 = new DataSet();
        cmd1.Fill(ds1);
   ...
   public void  statusragistry(string reg)
    ...
    public void allnonpaid(String user2)
    {
        ...
        SqlDataAdapter cmd = new SqlDataAdapter("select DISTINCT CUSTREGNO, APPNO AS 'ARAZI NO',LEFT(NAMEDOBADDRESS,20) AS 'NAME',SUBDUEDATE AS 'DUE DATE',plotno AS 'PLOT NO',CONCAT(mobile,' , ',mobile2) AS 'MOBILE',CHECKBY from wjstar1.customerreg1 where CUSTREGNO in(select DISTINCT CUSTREGNO from wjstar1.recipt1 where  usertype='"+user2+"' AND  CUSTREGNO not in(select DISTINCT CUSTREGNO from wjstar1.recipt1 where status='PAID' and DATE1 between '" + date1 + "' AND '" + date2 + "'))  AND  CUSTREGNO NOT IN(Select DISTINCT CUSTREGNO from wjstar1.customerreg1 where regstatus='completed'  OR regstatus='Cancel')", con1);
        DataSet ds = new DataSet();
        cmd.Fill(ds);
                    ...
                    if (DropDownList2.Text != "ALL ARAZI")
                    {
                        if (DropDownList2.Text != "152")
                        {
                           ...
                           // GridView1.DataBind();
                            ...
                            SqlDataAdapter cmd1 = new SqlDataAdapter("select sum(AMOUNTR) from wjstar1.recipt1 where status='PAID' AND usertype='heedrealestate' AND (DATE1 BETWEEN '" + date1 + "' AND '" + date2 + "') AND (CUSTREGNO IN (select DISTINCT CUSTREGNO from wjstar1.customerreg1 where APPNO='" + DropDownList2.Text + "' AND CUSTREGNO NOT IN(Select DISTINCT CUSTREGNO from wjstar1.customerreg1 where  regstatus='Cancel')))", con2);
                            DataSet ds1 = new DataSet();
                            cmd1.Fill(ds1);
                            Label2.Text = ds1.Tables[0].Rows[0][0].ToString();
                            con2.Close();
                    ...
                    if (DropDownList1.Text == "NON PAID")
                    {
                        ...
                        if (DropDownList2.Text != "ALL ARAZI")
                        {
                            if (DropDownList2.Text != "152")
                            {
                                ...
                                SqlDataAdapter cmd = new SqlDataAdapter("select DISTINCT CUSTREGNO, APPNO AS 'ARAZI NO',LEFT(NAMEDOBADDRESS,20) AS 'NAME',SUBDUEDATE AS 'DUE DATE',plotno AS 'PLOT NO',CONCAT(mobile,' , ',mobile2) AS 'MOBILE',CHECKBY from wjstar1.customerreg1 where CUSTREGNO in(select DISTINCT CUSTREGNO from wjstar1.recipt1 where  usertype='heedrealestate' AND  CUSTREGNO not in(select DISTINCT CUSTREGNO from wjstar1.recipt1 where status='PAID' and DATE1 between '" + date1 + "' AND '" + date2 + "'))  AND  APPNO='" + DropDownList2.Text + "' AND CUSTREGNO NOT IN(Select DISTINCT CUSTREGNO from wjstar1.customerreg1 where regstatus='completed'  OR regstatus='Cancel')", con1);
                                DataSet ds = new DataSet();
                                cmd.Fill(ds);
                                //GridView2.DataSource = ds;
                                //GridView2.DataBind();
                    ...
                    if (DropDownList1.Text == "NON PAID")
                    {
                        ...
                        if (DropDownList2.Text != "ALL ARAZI")
                        {
                            if (DropDownList2.Text != "152")
                            {
                                ...
                                SqlDataAdapter cmd = new SqlDataAdapter("select DISTINCT CUSTREGNO, APPNO AS 'ARAZI NO',LEFT(NAMEDOBADDRESS,20) AS 'NAME',SUBDUEDATE AS 'DUE DATE',plotno AS 'PLOT NO',CONCAT(mobile,' , ',mobile2) AS 'MOBILE',CHECKBY from wjstar1.customerreg1 where CUSTREGNO in(select DISTINCT CUSTREGNO from wjstar1.recipt1 where  usertype='Ashok8396' AND  CUSTREGNO not in(select DISTINCT CUSTREGNO from wjstar1.recipt1 where status='PAID' and DATE1 between '" + date1 + "' AND '" + date2 + "'))  AND  APPNO='" + DropDownList2.Text + "' AND CUSTREGNO NOT IN(Select DISTINCT CUSTREGNO from wjstar1.customerreg1 where regstatus='completed'  OR regstatus='Cancel')", con1);
                                DataSet ds = new DataSet();
                                cmd.Fill(ds);
                                //GridView2.DataSource = ds;
                                //GridView2.DataBind();
                    ...
                    if (DropDownList1.Text == "NON PAID")
                    {
                        ...
                        if (DropDownList2.Text != "ALL ARAZI")
                        {
                            if (DropDownList2.Text != "152")
                            {
                                ...
                                SqlDataAdapter cmd = new SqlDataAdapter("select DISTINCT CUSTREGNO, APPNO AS 'ARAZI NO',LEFT(NAMEDOBADDRESS,20) AS 'NAME',SUBDUEDATE AS 'DUE DATE',plotno AS 'PLOT NO',CONCAT(mobile,' , ',mobile2) AS 'MOBILE',CHECKBY from wjstar1.customerreg1 where CUSTREGNO in(select DISTINCT CUSTREGNO from wjstar1.recipt1 where  usertype='RAMAIPUROFFICE' AND  CUSTREGNO not in(select DISTINCT CUSTREGNO from wjstar1.recipt1 where status='PAID' and DATE1 between '" + date1 + "' AND '" + date2 + "'))  AND  APPNO='" + DropDownList2.Text + "' AND CUSTREGNO NOT IN(Select DISTINCT CUSTREGNO from wjstar1.customerreg1 where regstatus='completed'  OR regstatus='Cancel')", con1);
                                DataSet ds = new DataSet();
                                cmd.Fill(ds);
                                //GridView2.DataSource = ds;
                                //GridView2.DataBind();
                    ...
                    if (DropDownList1.Text == "NON PAID")
                    {
                        ...
                        if (DropDownList2.Text != "ALL ARAZI")
                        {
                            if (DropDownList2.Text != "152")
                            {
                                ...
                                SqlDataAdapter cmd = new SqlDataAdapter("select DISTINCT CUSTREGNO, APPNO AS 'ARAZI NO',LEFT(NAMEDOBADDRESS,20) AS 'NAME',SUBDUEDATE AS 'DUE DATE',plotno AS 'PLOT NO',CONCAT(mobile,' , ',mobile2) AS 'MOBILE',CHECKBY from wjstar1.customerreg1 where CUSTREGNO in(select DISTINCT CUSTREGNO from wjstar1.recipt1 where  usertype='MACHHARIYAOFFICE' AND  CUSTREGNO not in(select DISTINCT CUSTREGNO from wjstar1.recipt1 where status='PAID' and DATE1 between '" + date1 + "' AND '" + date2 + "'))  AND  APPNO='" + DropDownList2.Text + "' AND CUSTREGNO NOT IN(Select DISTINCT CUSTREGNO from wjstar1.customerreg1 where regstatus='completed'  OR regstatus='Cancel')", con1);
                                DataSet ds = new DataSet();
                                cmd.Fill(ds);
                               // GridView2.DataSource = ds;
                               // GridView2.DataBind();
                    ...
                    if (DropDownList1.Text == "NON PAID")
                    {
                        ...
                        if (DropDownList2.Text != "ALL ARAZI")
                        {
                            if (DropDownList2.Text != "152")
                            {
                                ...
                                SqlDataAdapter cmd = new SqlDataAdapter("select DISTINCT CUSTREGNO, APPNO AS 'ARAZI NO',LEFT(NAMEDOBADDRESS,20) AS 'NAME',SUBDUEDATE AS 'DUE DATE',plotno AS 'PLOT NO',CONCAT(mobile,' , ',mobile2) AS 'MOBILE',CHECKBY from wjstar1.customerreg1 where CUSTREGNO in(select DISTINCT CUSTREGNO from wjstar1.recipt1 where  usertype='IMRAN7905' AND  CUSTREGNO not in(select DISTINCT CUSTREGNO from wjstar1.recipt1 where status='PAID' and DATE1 between '" + date1 + "' AND '" + date2 + "'))  AND  APPNO='" + DropDownList2.Text + "' AND CUSTREGNO NOT IN(Select DISTINCT CUSTREGNO from wjstar1.customerreg1 where regstatus='completed'  OR regstatus='Cancel')", con1);
                                DataSet ds = new DataSet();
                                cmd.Fill(ds);
                                //GridView2.DataSource = ds;
                                //GridView2.DataBind();
