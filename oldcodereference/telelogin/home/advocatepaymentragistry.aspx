<%@ Page Language="C#" AutoEventWireup="true" CodeFile="advocatepaymentragistry.aspx.cs" Inherits="dialer_paymentragistry" %>
...
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
					...
					&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<a href="advpaymentpaymentdone.aspx" target="_blank">ADVOCATE PAYMENT</a>
                    <asp:Label ID="Label1" runat="server"></asp:Label>
                    </strong></td>
            </tr>
            <tr>
                <td class="auto-style6" style="background-color: #99FFCC">
...
&nbsp;&nbsp;
                    <asp:Button ID="Button4" runat="server" BackColor="#33CC33" CssClass="ui-priority-primary" Text="DEL" />
                    </strong></asp:Panel></td>
            </tr>
            <tr>
            ...
            <tr>
                <td>
                    <asp:Panel ID="Panel1" runat="server" Class="gvWidthHight">
                        <asp:GridView ID="GridView1" runat="server" BackColor="White" BorderColor="#CCCCCC" BorderStyle="None" BorderWidth="1px" CellPadding="4" ForeColor="Black" GridLines="Horizontal" Width="100%" AutoGenerateColumns="False" Style="text-align:left;" OnRowDataBound="GridView1_RowDataBound">
                            <Columns>
