...
public partial class regcertificate : System.Web.UI.Page
{
   ...
   string s = ConfigurationManager.ConnectionStrings["amar"].ConnectionString.ToString();
    ...
    public void bindl()
    {
		...
		con.Open();
        SqlDataAdapter da7 = new SqlDataAdapter("select DISTINCT loc from wjstar1.ploted1 where arazino not in(select DISTINCT arazino from softploted1)", con);
         ...
         public void fetch()
    {
        ...
        if (dr.HasRows == true)
        {
         ...
         public Double dppay()
         {
             ...
             if (arazi == "152" || arazi == "506" || arazi == "519" || arazi == "239" || arazi == "161GHA" || arazi == "186MI" || arazi == "RAMAI137" || arazi=="159" || arazi=="1452"  || arazi=="357" || arazi=="217" || arazi=="187-KHA" || arazi=="320" || arazi=="356" || arazi=="353" || arazi=="37 JAJMAU" || arazi=="419" || arazi=="1413"  || arazi=="308" || arazi=="340" || arazi=="1731" || arazi=="190" || arazi=="246_12BEEGHA" || arazi=="169" || arazi=="179" || arazi=="343" || arazi=="JDBHATTA"  || arazi=="156" || arazi=="397")
             {
                 if (TextBox4.Text != "")
                 {
