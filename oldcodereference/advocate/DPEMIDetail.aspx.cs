...
public partial class Detail : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        else
        {
           ...
           TextBox1.Text = "01/" + m + "/" + y;
			//TextBox1.Text = "01/10/2022";
    ...
    public void find(string m,string y)
    {
        try
        {
            int l = DropDownList3.Items.Count;
            for (int i = 0; i < l; i++)
            {
                payment = 0;
                sumemipaid = 0;
                ...
                if (DropDownList1.Text == "PAID")
                {
                   ...
                   // us = "ALL USER";
                    ...
                    SqlDataAdapter da = new SqlDataAdapter("select ID from lateemipay where month(date)='" + m + "' AND year (date)='" + y + "' AND user1='" + us + "'", con1);
...
string ddd = DateTime.Now.ToString("MM/dd/yyyy hh:mm tt");
						//string ddd = "10/31/2022";
                        SqlCommand cmd = new SqlCommand("update lateemipay set date='" + ddd + "',user1='" + us + "',totallateemi=" + Label29.Text + ",lateemimonth=" + Label32.Text + ",totalpaidemi=" + Label31.Text + ",totalbalemi=" + Label33.Text + "  where month(date)='" + m + "' AND year (date)='" + y + "' AND user1='" + us + "'", con1);
                    ...
                    {
                        DateTime f1 = DateTime.Today.AddMonths(-1);
                        int mon = Convert.ToInt32(f1.Month);
                        int year = Convert.ToInt32(f1.Year);

                        con1.Open();

                        SqlDataAdapter da1 = new SqlDataAdapter("select totallateemi from lateemipay where month(date)='" + mon + "' AND year (date)='" + year + "' AND user1='" + us + "'", con1);
                        ...
                        {
                            start = Convert.ToDouble(ds1.Tables[0].Rows[0][0].ToString());
                        }
                        else
                        {
                            start = 0;
                       ...
                       string ddd = DateTime.Now.ToString("MM/dd/yyyy hh:mm tt");
						//string ddd = "10/31/2022";
                       SqlCommand cmd = new SqlCommand("insert into lateemipay (date,user1,totallateemi,lateemimonth,totalpaidemi,totalbalemi,startpmt)values('" + ddd + "','" + us + "'," + Label29.Text + "," + Label32.Text + "," + Label31.Text + "," + Label33.Text + ","+start+")", con1);
                        int k = cmd.ExecuteNonQuery();
                        con1.Close();
                    }
