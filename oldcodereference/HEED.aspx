<%@ Page Language="C#" AutoEventWireup="true" CodeFile="HEED.aspx.cs" Inherits="NewFolder1_HEED" %>
	      ...
	      <div class="collapse navbar-collapse" id="ftco-nav">
	        <ul class="navbar-nav ml-auto">
	         ...
	         <li class="nav-item"><a href="contact.aspx" class="nav-link">Contact</a></li>
                <li class="nav-item"><a href="Plotdetails.aspx" class="nav-link" target="_blank">Get Plot Details</a></li>
	        </ul>
	      </div>
	    </div>
	  </nav>
...
>HEED REAL ESTATE PVT LTD.</h1>
    ...
    <section class="ftco-section ftco-no-pb">
			<div class="container">
	          ...
	          <div class="heading-section p-md-5">
	            ...
	            हीद रियल इस्टेट प्राइवेट लिमिटेड एक प्राइवेट लिमिटेड कम्पनी है। कम्पनी का मुख्य कार्य भारतवर्ष में जमीन खरीदना एवं बेचना, वैज्ञानिक तरीकों से जमीन का विकास एवं नये प्रोजेक्ट पर कार्य करना, अविकसित जमीनों को खेती योग्य बनाना एवं जमीन से सम्बन्धित कार्य करना है। इसी आधार पर कार्य करते हुए अपने सहभागियों को तय समय में जमीन देना एवं समय पर उन्हें जमीन से होने वाला मुनाफा देना शामिल है।
	          </div>
					</div>
				</div>
			</div>
  ...
  Copyright &copy;<script>                      document.write(new Date().getFullYear());</script> All rights reserved  <i class="icon-heart color-danger" aria-hidden="true"></i> by CSIT
