...
public partial class customer_details : System.Web.UI.Page
{
    ...
    public void showbroker()
    {
        ...
        SqlDataAdapter da = new SqlDataAdapter("select ID,CUSTREGNO,CHECKBY,DATE,TOTAL,PER,PAID,REASON from newbrokerpaid where CUSTREGNO='"+TextBox1.Text+"'", con1);
    ...
    public void reciptbind()
    {
        ...
        SqlDataAdapter da = new SqlDataAdapter("select SUM(AMOUNT) from reciptreturn where CUSTREGNO='" + TextBox1.Text + "'", con1);
        DataSet ds = new DataSet();
        da.Fill(ds);
        con1.Close();
        if (ds.Tables[0].Rows.Count > 0)
    ...
    protected void Button1_Click(object sender, EventArgs e)
    {
        try
        {
            ...
            SqlDataAdapter da = new SqlDataAdapter("select r.RECIPT,r.DATE,r.INSTNO,r.AMOUNTR,r.AMOUNTWORD AS 'AMTWORD',r.chequenopay,r.userstatus AS 'STATUS',discount as 'RECTYPE',r.deldate from wjstar1.recipt1 r LEFT JOIN wjstar1.customerreg1 u ON r.CUSTREGNO=u.CUSTREGNO where r.CUSTREGNO='" + TextBox1.Text + "' ORDER BY r.DATE1 ASC", con1);
            DataSet ds = new DataSet();
            da.Fill(ds);
            con1.Close();
con1.Open();
SqlDataAdapter da1 = new SqlDataAdapter("select r.CUSTREGNO AS 'REGNO',u.NAMEDOBADDRESS AS 'ADDRESS',r.PLANTERM AS 'PLAN',u.CONSAMOUNT AS 'VALUE',r.RECIPT,r.DATE,r.INSTNO,r.AMOUNTR,r.NEXTDATE,CONCAT(u.mobile,' , ',u.mobile2,',',u.mobile3) AS 'Mobile No',u.APPNO AS 'ARAZI NO',r.AMOUNTWORD AS 'AMT WORD',u.CHECKBY,u.plotno,u.PLOTSIZE,u.regstatus from wjstar1.recipt1 r LEFT JOIN wjstar1.customerreg1 u ON r.CUSTREGNO=u.CUSTREGNO where r.CUSTREGNO='" + TextBox1.Text + "'", con1);
 DataSet ds1 = new DataSet();
            ...
            if (ds1.Tables[0].Rows[0][15].ToString() == "completed" || ds1.Tables[0].Rows[0][15].ToString() == "Registry")
            {
                Image1.Visible = true;
            }
            else
    ...
    public void cheque(string reg)
    {
        SqlConnection con = new SqlConnection(s);
        con.Open();
       
        SqlDataAdapter da1 = new SqlDataAdapter("SELECT ID,CDATE,CHEQUENO,CAMOUNT,CHEQUETYPE,STATUS,paiddate,deletevalue,BSTATUS,BDATE,finalstatus from chequedetails WHERE CUSTREGNO='" + reg + "' ORDER BY CDATE ASC", con);
        DataSet ds1 = new DataSet();
        da1.Fill(ds1);
        con.Close();
	 ...
	 protected void GridView1_RowDataBound(object sender, GridViewRowEventArgs e)
    {
     ...
     protected void Button2_Click(object sender, EventArgs e)
     {
         ...
         string ddd = mm + "/" + dd + "/" + yy;
         SqlCommand cmd = new SqlCommand("insert into newbrokerpaid(CUSTREGNO,CHECKBY,DATE,TOTAL,PER,PAID,REASON)values('" + Label13.Text + "','" + Label12.Text + "','" + ddd + "'," + TextBox4.Text + "," + TextBox5.Text + "," + TextBox6.Text + ",'"+TextBox7.Text+"')", con1);
    ...
    protected void GridView2_RowDeleting(object sender, GridViewDeleteEventArgs e)
    {
        ...
        SqlCommand cmd = new SqlCommand("delete from newbrokerpaid where ID=" + id + "", con);
    ...
    public void showrecipt()
    {
        ...
        SqlDataAdapter da = new SqlDataAdapter("select ID,DATE,AMOUNT,REASON from reciptreturn where CUSTREGNO='"+TextBox1.Text+"'", con1);
        DataSet ds = new DataSet();
        da.Fill(ds);
        con1.Close();
        if (ds.Tables[0].Rows.Count > 0)
    ...
    protected void Button3_Click(object sender, EventArgs e)
    {
         ...
         string yy = s2.Substring(6, 4);
         string ddd = mm + "/" + dd + "/" + yy;
         SqlCommand cmd = new SqlCommand("insert into reciptreturn (DATE,AMOUNT,REASON,CUSTREGNO)values('"+ddd+"',"+TextBox11.Text+",'"+TextBox12.Text+"','"+TextBox1.Text+"')", con1);
         int a = cmd.ExecuteNonQuery();
         con1.Close();
         if (a != 0)
         {
    ...
    protected void  GridView3_RowDeleting(object sender, GridViewDeleteEventArgs e)
        {
            SqlConnection con = new SqlConnection(s);
                  ...
                  int id = Convert.ToInt16(GridView3.DataKeys[e.RowIndex].Values["ID"].ToString());
                      SqlCommand cmd = new SqlCommand("delete from reciptreturn where ID=" + id + "", con);
