<%@ Page Language="C#" AutoEventWireup="true" CodeFile="totalcheque.aspx.cs" Inherits="kishan_totalcheque" %>
        ...
        <table class="style1">
            <tr>
                <td bgcolor="#FFFFCC" class="style2" colspan="3">
                    <strong>TOTAL CHEQUE DETAILS</strong></td>
            </tr>
            <tr>
            ...
            <tr>
                <td colspan="3">
                    <strong>OLD KISHAN CHEQUE</strong><br />
                    <br />
			  ...
			  <asp:TemplateField>
                  ...
                  <asp:Label ID="date6" runat="server" Text='<%# Eval("status")%>'></asp:Label>
                    ...
                    <strong>NEW KISHAN CHEQUE<asp:GridView ID="GridView3" runat="server" Width="100%" 
                        AutoGenerateColumns="False" CellPadding="4" ForeColor="#333333" 
			  ...
			  <asp:TemplateField>
                  ...
                  <asp:Label ID="d8" runat="server" Text='<%# Eval("status1")%>'></asp:Label>
                    ...
                    <strong>NEW INVESTER CHEQUE</strong><asp:GridView ID="GridView4" runat="server" Width="100%" 
                        AutoGenerateColumns="False" BackColor="White" BorderColor="#3366CC" 
                        BorderStyle="None" BorderWidth="1px" CellPadding="4" 
