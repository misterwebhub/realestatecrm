<%@ Page Language="C#" AutoEventWireup="true" CodeFile="reciptupashoktemp.aspx.cs" Inherits="kishan_Bin_map2_174mi_reciptupashok" %>
  ...
  <script type="text/javascript" src="https://code.jquery.com/ui/1.12.1/jquery-ui.js"></script>
	<script type="text/javascript">
	    ...
	    function openRequestedPopup() {
	        ...
	        windowObjectReference = window.open("http://sms.webguard.in/api/sendhttp.php?authkey=330026A7runOjvu5f533531P1&mobiles=9129822343&message=THANK YOU FOR PAID INSTALLMENT- " + s2 + "Rs AND INSTALLMENT NO. " + s3 + " and Registration No is " + s4 + " ON HEED REAL ESTATE PVT LTD.&sender=HEEDKP&route=4&DLT_TE_ID=1207161743797366419");
...
&nbsp; HEED REAL
					...
					<tr>
						<td style="font-size:18pt;text-align:center;">ESTATE PRIVATE LIMITEDD</td>
					</tr>
					<tr>
					...
					<table style="width:100%;height:240px;">
						...
						<tr>
							<td class="style4">Total Land Value Rs.</td><td class="style6">
                                <asp:TextBox ID="TextBox14" runat="server"  Height="22px" 
						...
						<tr>
                            ...
                            <asp:TextBox ID="TextBox16" runat="server" Height="22px" 
                                    style="margin-left: 0px" Width="115px" AutoPostBack="True" ontextchanged="TextBox16_TextChanged" 
                                ></asp:TextBox>
                            </td>
							<td class="style3">
