...
&nbsp;&nbsp;&nbsp;
            ...
            <tr>
                <td class="style3" colspan="2">
                    &nbsp;<span class="style6"><strong>Total Amt
                    <asp:Label ID="Label13" runat="server" Font-Bold="True" Font-Size="Large" 
                        ForeColor="Red"></asp:Label>
                    &nbsp;Recipt Amt <asp:Label ID="Label3" runat="server" Font-Bold="True" Font-Size="Large" 
                        ForeColor="Red"></asp:Label>
                    </strong></span>&nbsp;&nbsp;<strong>Total Charge</strong>&nbsp;<asp:Label ID="Label10" runat="server" style="font-weight: 700; color: #000066"></asp:Label>
                    &nbsp;&nbsp;<strong>Extra Amt</strong> &nbsp;<asp:Label ID="Label12" 
                        runat="server" ForeColor="Red" style="font-weight: 700"></asp:Label>
                    &nbsp; 
                    <asp:Label ID="Label5" runat="server" Text="RECIEVE AMOUNT" 
                        style="font-weight: 700"></asp:Label>
                    <strong>&nbsp; </strong>
                    <asp:TextBox ID="TextBox3" runat="server" Height="25px" Width="80px"></asp:TextBox>
&nbsp;<asp:Label ID="Label7" runat="server" Text="RECIEVE DATE" 
                        style="font-weight: 700"></asp:Label>
                    &nbsp;<asp:TextBox ID="TextBox4" runat="server" Height="24px" class="txt1" 
                        ontextchanged="TextBox1_TextChanged" Width="87px"></asp:TextBox>
                    &nbsp;&nbsp;<strong>REASON</strong>&nbsp;
                    <asp:TextBox ID="TextBox56" runat="server" Height="35px" TextMode="MultiLine" 
           ...
           <asp:BoundField DataField="date" HeaderText="DATE" DataFormatString="{0:dd/MM/yyyy}" >
                ...
                <asp:BoundField DataField="class1" HeaderText="Class">
                 <ItemStyle Width="70px" />
                     ...
                     <br />
                    <span class="style6"><strong><span class="style8">&nbsp;Total Extra Amount&nbsp;&nbsp;&nbsp;&nbsp; 
                    :</span><asp:Label ID="Label11" runat="server" ForeColor="Red" Text="Label"></asp:Label> 
                    <br />
                    </strong></span>
                    </br>
					<div class="WrapText">
                    <asp:GridView ID="GridView1" runat="server" BackColor="White" 
                        ...
                        <Columns>
							...
							<asp:BoundField DataField="INSTNO" HeaderText="EMI" >
								  <ItemStyle Width="50px" />
                            </asp:BoundField>
                            <asp:BoundField DataField="che" HeaderText="CHEUQE NO." >
								  <ItemStyle Width="80px" />
                            </asp:BoundField>
                                <asp:BoundField DataField="payto" HeaderText="PAY TO" >
									  <ItemStyle Width="90px" />
                            </asp:BoundField>
                            <asp:BoundField DataField="RECIPT" HeaderText="REC.NO" >
								  <ItemStyle Width="70px" />
                            </asp:BoundField>
                            <asp:BoundField DataField="ARAZI" HeaderText="ARAZI NO" >
								  <ItemStyle Width="90px" />
                            </asp:BoundField>
                            <asp:BoundField DataField="PLOT" HeaderText="P.NO" >
								  <ItemStyle Width="70px" />
                            </asp:BoundField>
                            <asp:BoundField DataField="SIZE" HeaderText="P.SIZE" >
								  <ItemStyle Width="70px" />
                            </asp:BoundField>
                            <asp:BoundField DataField="CHECKBY" HeaderText="CHECKBY" >
