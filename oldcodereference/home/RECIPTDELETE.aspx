...
<body>
    ...
    <div style="background-color:bisque;width:100%;height:600px;box-shadow:0px 0px 10px black;">
...
&nbsp;&nbsp;
                    ...
                    <asp:Button ID="Button3" runat="server" BackColor="#00CC00" Height="28px" 
                        ...
                        Width="131px" />
                &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; CUSTOMER REG.NO.
                    <asp:TextBox ID="TextBox3" runat="server" Height="28px" Width="93px"></asp:TextBox>
&nbsp;&nbsp;
                    <asp:Button ID="Button5" runat="server" Text="CHECK" Width="67px" 
                        Height="30px" onclick="Button5_Click" style="font-weight: 700" />
                &nbsp;&nbsp;&nbsp; ARAZI.NO&nbsp; <asp:DropDownList ID="DropDownList1" runat="server">
                    </asp:DropDownList>
&nbsp;&nbsp;&nbsp;
                    <asp:Button ID="Button4" runat="server" Text="CHANGE" Width="73px" 
                        Height="30px" style="font-weight: 700" onclick="Button4_Click" />
                </td>
            </tr>
            <tr>
                <td class="auto-style4">
                    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; 
                    DETAILS -&nbsp; &nbsp;<asp:Label ID="Label4" runat="server" ForeColor="Red" style="font-weight: 700" 
                        Text="Label"></asp:Label>
                </td>
            </tr>
            <tr>
