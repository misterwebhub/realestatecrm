...
public partial class arazi161gha : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        try
        {
            ...
            con.Open();
            SqlDataAdapter da = new SqlDataAdapter("select arazi,plotno,status from arazimap where arazi='161GHA' ", con);
            DataSet ds = new DataSet();
            da.Fill(ds);
            con.Close();
            con.Open();
            SqlDataAdapter da1 = new SqlDataAdapter("select arazi,plotno,status from arazimap where CUSTREGNO IN(select CUSTREGNO from wjstar1.customerreg1 where APPNO='161GHA' AND regstatus IN('Registry'))", con);
            DataSet ds1 = new DataSet();
            da1.Fill(ds1);
            con.Close();
            con.Open();
            SqlDataAdapter da2 = new SqlDataAdapter("select arazi,plotno,status from arazimap where CUSTREGNO IN(select CUSTREGNO from wjstar1.customerreg1 where APPNO='161GHA' AND regstatus IN('completed'))", con);
            DataSet ds2 = new DataSet();
            da2.Fill(ds2);
            con.Close();
            con.Open();
            SqlDataAdapter da3 = new SqlDataAdapter("select count(plotno) from arazimap where CUSTREGNO IN(select CUSTREGNO from wjstar1.customerreg1 where APPNO='161GHA' AND regstatus IN('completed'))", con);
            DataSet ds3 = new DataSet();
            da3.Fill(ds3);
            con.Close();
			 SqlDataAdapter da5 = new SqlDataAdapter("select arazi,plotno,status from arazimap where arazi='161GHA' AND CUSTREGNO IN(select CUSTREGNO from ARAZINOTSALE where ARAZI='161GHA') ", con);
            ...
            con.Open();
            SqlDataAdapter da11 = new SqlDataAdapter("select arazi,plotno,status from arazimap where arazi='169' ", con);
            DataSet ds11 = new DataSet();
            da11.Fill(ds11);
            con.Close();
            con.Open();
            SqlDataAdapter da12 = new SqlDataAdapter("select arazi,plotno,status from arazimap where CUSTREGNO IN(select CUSTREGNO from wjstar1.customerreg1 where APPNO='169' AND regstatus IN('Registry'))", con);
            DataSet ds12 = new DataSet();
            da12.Fill(ds12);
            con.Close();
            con.Open();
            SqlDataAdapter da23 = new SqlDataAdapter("select arazi,plotno,status from arazimap where CUSTREGNO IN(select CUSTREGNO from wjstar1.customerreg1 where APPNO='169' AND regstatus IN('completed'))", con);
            DataSet ds23= new DataSet();
            da23.Fill(ds23);
            con.Close();
            con.Open();
            SqlDataAdapter da32 = new SqlDataAdapter("select count(plotno) from arazimap where CUSTREGNO IN(select CUSTREGNO from wjstar1.customerreg1 where APPNO='169' AND regstatus IN('completed'))", con);
            ...
            if (ds11.Tables[0].Rows.Count > 0)
            {
                ...
                {
                    if (ds11.Tables[0].Rows[i][2].ToString() == "empty")
                    {
                        
                        if (ds11.Tables[0].Rows[i][1].ToString() == "235")
                            p235.BackImageUrl = "amar.gif";
                        if (ds11.Tables[0].Rows[i][1].ToString() == "236")
                            p236.BackImageUrl = "amar.gif";
                        if (ds11.Tables[0].Rows[i][1].ToString() == "237")
                            p237.BackImageUrl = "amar.gif";
                        if (ds11.Tables[0].Rows[i][1].ToString() == "238")
                            p238.BackImageUrl = "amar.gif";
                        if (ds11.Tables[0].Rows[i][1].ToString() == "239")
                            p239.BackImageUrl = "amar.gif";
                        if (ds11.Tables[0].Rows[i][1].ToString() == "240")
                            p240.BackImageUrl = "amar.gif";
                        if (ds11.Tables[0].Rows[i][1].ToString() == "241")
                            p241.BackImageUrl = "amar.gif";
                        if (ds11.Tables[0].Rows[i][1].ToString() == "242")
                            p242.BackImageUrl = "amar.gif";
                        if (ds11.Tables[0].Rows[i][1].ToString() == "243")
                            p243.BackImageUrl = "amar.gif";
                        if (ds11.Tables[0].Rows[i][1].ToString() == "244")
                            p244.BackImageUrl = "amar.gif";
                        if (ds11.Tables[0].Rows[i][1].ToString() == "245")
                            p245.BackImageUrl = "amar.gif";
                        if (ds11.Tables[0].Rows[i][1].ToString() == "246")
                            p246.BackImageUrl = "amar.gif";
                        if (ds11.Tables[0].Rows[i][1].ToString() == "247")
                            p247.BackImageUrl = "amar.gif";

                    }
                    if (ds11.Tables[0].Rows[i][2].ToString() == "book")
                    {
                                               if (ds11.Tables[0].Rows[i][1].ToString() == "235")
            ...
            if (ds12.Tables[0].Rows.Count > 0)
            {
                for (int i = 0; i < ds12.Tables[0].Rows.Count; i++)
                {
                    ...
                    if (ds12.Tables[0].Rows[i][1].ToString() == "235")
                        p235.BackColor = Color.Red;
                    if (ds12.Tables[0].Rows[i][1].ToString() == "236")
                        p236.BackColor = Color.Red;
                    if (ds12.Tables[0].Rows[i][1].ToString() == "237")
                        p237.BackColor = Color.Red;
                    if (ds12.Tables[0].Rows[i][1].ToString() == "238")
                        p238.BackColor = Color.Red;
                    if (ds12.Tables[0].Rows[i][1].ToString() == "239")
                        p239.BackColor = Color.Red;
                    if (ds12.Tables[0].Rows[i][1].ToString() == "240")
                        p240.BackColor = Color.Red;
                    if (ds12.Tables[0].Rows[i][1].ToString() == "241")
                        p241.BackColor = Color.Red;
                    if (ds12.Tables[0].Rows[i][1].ToString() == "242")
                        p242.BackColor = Color.Red;
                    if (ds12.Tables[0].Rows[i][1].ToString() == "243")
                        p243.BackColor = Color.Red;
                    if (ds12.Tables[0].Rows[i][1].ToString() == "244")
                        p244.BackColor = Color.Red;
                    if (ds12.Tables[0].Rows[i][1].ToString() == "245")
                        p245.BackColor = Color.Red;
                    if (ds12.Tables[0].Rows[i][1].ToString() == "246")
                        p246.BackColor = Color.Red;
                    if (ds12.Tables[0].Rows[i][1].ToString() == "247")
            ...
            if (ds23.Tables[0].Rows.Count > 0)
            {
                for (int i = 0; i < ds23.Tables[0].Rows.Count; i++)
                {
                    ...
                    if (ds23.Tables[0].Rows[i][1].ToString() == "235")
                        p235.BackImageUrl = "blue.gif";
                    if (ds23.Tables[0].Rows[i][1].ToString() == "236")
                        p236.BackImageUrl = "blue.gif";
                    if (ds23.Tables[0].Rows[i][1].ToString() == "237")
                        p237.BackImageUrl = "blue.gif";
                    if (ds23.Tables[0].Rows[i][1].ToString() == "238")
                        p238.BackImageUrl = "blue.gif";
                    if (ds23.Tables[0].Rows[i][1].ToString() == "239")
                        p239.BackImageUrl = "blue.gif";
                    if (ds23.Tables[0].Rows[i][1].ToString() == "240")
                        p240.BackImageUrl = "blue.gif";
                    if (ds23.Tables[0].Rows[i][1].ToString() == "241")
                        p241.BackImageUrl = "blue.gif";
                    if (ds23.Tables[0].Rows[i][1].ToString() == "242")
                        p242.BackImageUrl = "blue.gif";
                    if (ds23.Tables[0].Rows[i][1].ToString() == "243")
                        p243.BackImageUrl = "blue.gif";
                    if (ds23.Tables[0].Rows[i][1].ToString() == "244")
                        p244.BackImageUrl = "blue.gif";
                    if (ds23.Tables[0].Rows[i][1].ToString() == "245")
                        p245.BackImageUrl = "blue.gif";
                    if (ds23.Tables[0].Rows[i][1].ToString() == "246")
                        p246.BackImageUrl = "blue.gif";
                    if (ds23.Tables[0].Rows[i][1].ToString() == "247")
            ...
            if (ds.Tables[0].Rows.Count > 0)
            {
                for (int i = 0; i < ds.Tables[0].Rows.Count; i++)
                {
                    ...
                    if (ds.Tables[0].Rows[i][2].ToString() == "book")
                    {
                        ...
                        if (ds.Tables[0].Rows[i][1].ToString() == "151")
                            p151.BackColor = Color.Green;
                        if (ds.Tables[0].Rows[i][1].ToString() == "152")
                            p152.BackColor = Color.Green;
                        if (ds.Tables[0].Rows[i][1].ToString() == "153")
                            p153.BackColor = Color.Green;
                        if (ds.Tables[0].Rows[i][1].ToString() == "154")
                            p154.BackColor = Color.Green;
                        if (ds.Tables[0].Rows[i][1].ToString() == "155")
                            p155.BackColor = Color.Green;
                        if (ds.Tables[0].Rows[i][1].ToString() == "156")
                            p156.BackColor = Color.Green;
                        if (ds.Tables[0].Rows[i][1].ToString() == "157")
                            p157.BackColor = Color.Green;
                        if (ds.Tables[0].Rows[i][1].ToString() == "158")
                            p158.BackColor = Color.Green;
                        if (ds.Tables[0].Rows[i][1].ToString() == "159")
                            p159.BackColor = Color.Green;
                        if (ds.Tables[0].Rows[i][1].ToString() == "160")
                            p160.BackColor = Color.Green;
                        if (ds.Tables[0].Rows[i][1].ToString() == "161")
                            p161.BackColor = Color.Green;
                        if (ds.Tables[0].Rows[i][1].ToString() == "162")
                            p162.BackColor = Color.Green;
                        if (ds.Tables[0].Rows[i][1].ToString() == "163")
                            p163.BackColor = Color.Green;
                        if (ds.Tables[0].Rows[i][1].ToString() == "164")
                        ...
                        if (ds.Tables[0].Rows[i][1].ToString() == "178")
                            p178.BackColor = Color.Green;
                        if (ds.Tables[0].Rows[i][1].ToString() == "179")
                            p179.BackColor = Color.Green;
                       // if (ds.Tables[0].Rows[i][1].ToString() == "180")
                          //  p180.BackColor = Color.Green;
                        if (ds.Tables[0].Rows[i][1].ToString() == "181")
                            p181.BackColor = Color.Green;
                        if (ds.Tables[0].Rows[i][1].ToString() == "182")
                ...
                for (int i = 0; i < ds5.Tables[0].Rows.Count; i++)
                {
                   ...
                   /* if (ds5.Tables[0].Rows[i][1].ToString() == "96")
                    ...
                    if (ds5.Tables[0].Rows[i][1].ToString() == "178")
                        p178.BackImageUrl = "notsale.jpg";
                    if (ds5.Tables[0].Rows[i][1].ToString() == "179")
                        p179.BackImageUrl = "notsale.jpg";
                   // if (ds5.Tables[0].Rows[i][1].ToString() == "180")
                     //   p180.BackImageUrl = "notsale.jpg";
                    if (ds5.Tables[0].Rows[i][1].ToString() == "181")
                        p181.BackImageUrl = "notsale.jpg";
