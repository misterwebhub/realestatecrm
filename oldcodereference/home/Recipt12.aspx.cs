    ...
    public void entry(string usertype, string cheq)
    {
        try
        {
         ...
         DateTime date57 = Convert.ToDateTime("09/01/2022");
				...
				TextBox17.Text=date56.ToString();
				TextBox18.Text=date57.ToString();
