<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Reciptup.aspx.cs" Inherits="Reciptup" %>
  ...
  <script type="text/javascript" src="https://code.jquery.com/ui/1.12.1/jquery-ui.js"></script>
	...
	<script type="text/javascript">
	    ...
	    function openRequestedPopup() {
			...
			windowObjectReference = window.open("http://sms.webguard.in/api/sendhttp.php?authkey=330026A7runOjvu5f533531P1&mobiles=9696446268&message=Your Update form heedrealestate on Request Receipt no "+s2+" OTP is " + s + "&sender=HEEDKP&route=4&DLT_TE_ID=1207161743745105035");
					...
					<tr>
						<td style="font-size:18pt;text-align:center;">
                            <asp:Label ID="Label15" runat="server" 
                                style="font-size:small; color: #FFFFFF;" Text="Label" 
                                Font-Bold="True" ForeColor="Red"></asp:Label>
                            ESTATE PRIVATE LIMITED</td>
					</tr>
					<tr>
				...
				<table style="padding:2px;">
					<tr><td>RECEIPT. No.</td><td>
                        <asp:TextBox ID="TextBox1" runat="server"   
                            style="margin-left:20px;" Height="24px" Width="93px"  ></asp:TextBox></td><td>
                        &nbsp;
					...
					<tr>
						...
						<td colspan="2" rowspan="2">
                            <asp:Panel ID="Panel1" runat="server" BackColor="Lime" Height="65px">
                                ...
                                <br />
                                Del Date
                                <asp:TextBox ID="TextBox24" runat="server" class="txt1" Height="22px" 
			...
			<tr>
				<td style="width:70%;">
					<table style="width:100%;height:240px;">
                        <tr>
							<td class="style4">Total Land Value Rs.</td><td><asp:TextBox ID="TextBox14" runat="server"  ></asp:TextBox></td>
                            <td class="style7" >Mode of Payment :&nbsp;
                            </td><td >
                                <asp:DropDownList ID="DropDownList1" runat="server" Height="19px" Width="80px">
                            ...
                            &nbsp;<asp:Label ID="Label21" runat="server" style="font-weight: 700; color: #FF0000" 
                                ...
                                <span class="style7">&nbsp;
                                <asp:TextBox ID="TextBox23" runat="server" Height="24px" Width="84px">0</asp:TextBox>
                                </span>
                            </td>
						</tr>
						<tr>
							<td class="style4"><span 
                                ...
                                Amount Rs.</span></td><td class="style5">
                            <asp:TextBox ID="TextBox15" runat="server"  ></asp:TextBox>
                            </td>
							<td class="style7">Plan Name & Term</td><td>
                            <asp:TextBox ID="TextBox11" runat="server" Height="22px" Width="85px" ></asp:TextBox>&nbsp;
                                <asp:Label ID="Label22" runat="server" style="font-weight: 700; color: #FF0000" 
                                    Text="USER"></asp:Label>
                            &nbsp;
                            <asp:DropDownList ID="DropDownList2" runat="server" Height="24px" Width="105px">
                                <asp:ListItem>---SELECT---</asp:ListItem>
                            </asp:DropDownList>
                            </td>
						</tr>
						<tr>
							<td class="style4">Amount Received</td><td class="style5"><asp:TextBox ID="TextBox13" runat="server" 
                                AutoPostBack="True" ontextchanged="TextBox13_TextChanged"  ></asp:TextBox></td>
                            <td class="style7">Downpayment</td><td>
						...
						<tr>
							<td class="style4">2% Late Charges Rs.</td><td class="style5">
                            <asp:TextBox ID="TextBox16" runat="server" AutoPostBack="True" 
                                ontextchanged="TextBox16_TextChanged"  ></asp:TextBox></td>
                            <td class="style7">Installment</td><td>
						...
						<tr>
							<td class="style4">Cheque Bounce Charge</td><td class="style5">
                            <asp:TextBox ID="TextBox22" runat="server" AutoPostBack="True" 
