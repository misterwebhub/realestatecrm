<%@ Page Language="C#" AutoEventWireup="true" CodeFile="PLOTDET.aspx.cs" Inherits="PLOTDET" %>
        ...
        <table class="style1" border="2">
            ...
            <tr>
                ...
                <td class="style30" bgcolor="#00FF99">
                    <span class="style31">&nbsp;&nbsp;<asp:Label ID="Label4" runat="server" 
...
&nbsp; Registry Status
                    ...
                    <asp:Button ID="Button4" runat="server" BackColor="Black" ForeColor="White" 
                        ...
                        Width="43px" onclick="Button4_Click" />
                </td>
            </tr>
            <tr>
...
&nbsp;
                    <asp:Button ID="Button6" runat="server" Height="27px" onclick="Button6_Click" 
                        style="font-weight: 700" Text="FREE" Width="49px" />
                </td>
                <td class="style34" bgcolor="#00FF99">
                    <span class="style31">
...
&nbsp;&nbsp;
                    <asp:Button ID="Button5" runat="server" BackColor="#CCFFFF" Font-Bold="True" 
                        Height="26px" onclick="Button5_Click1" Text="Move" Width="59px" />
                </td>
            </tr>
            <tr>
