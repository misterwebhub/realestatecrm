<%@ Page Title="" Language="C#" MasterPageFile="~/chain system/admin/agenthome/agentmaster.master" AutoEventWireup="true" CodeFile="agentself.aspx.cs" Inherits="admin_agenthome_agentself" %>
              ...
              <div class="card-body overflow-auto">
                <div id="example3_wrapper" class="dataTables_wrapper dt-bootstrap4 no-footer"><div class="row">
                 ...
                 <asp:ImageButton ID="btnPrint" runat="server" ImageUrl="~/chain system/admin/agenthome/print.png" 
                     ...
                     style="height:30px;width:30px;" onclick="ExportToExcel" /> &nbsp;&nbsp;&nbsp;&nbsp;<a href="cs.aspx" target=_blank>View Graph</a></div>
