...
Label2.Text = " ";
                ...
                // TextBox20.Text = ds.Tables[0].Rows[0][20].ToString();
                    ...
                    if (ds1.Tables[0].Rows.Count > 0)
                     {
                        ...
                        plotno = plotbind(ds.Tables[0].Rows[0][13].ToString());
                 ...
                 else
                 {
                     String ar = ds.Tables[0].Rows[0][13].ToString();
                           ...
                           //plotno = plotbind();
                           con.Open();
                           SqlDataAdapter da320 = new SqlDataAdapter("select plotno,arazi from arazimap where CUSTREGNO='" + TextBox21.Text + "' AND arazi='"+ar+"'", con);
                           DataSet ds320 = new DataSet();
                           da320.Fill(ds320);
                           con.Close();
                           ablock.Clear();
                           bblock.Clear();
                           ...
                           dblock.Clear();
						    eblock.Clear();
						       fblock.Clear();
                           if (ds320.Tables[0].Rows.Count > 0)
                           {
                               for (int j = 0; j < ds320.Tables[0].Rows.Count; j++)
                               {

                                   ablock.Add(Convert.ToInt32(ds320.Tables[0].Rows[j][0].ToString()));
    ...
    public string plotbind(string ar)
         {
             string plot = "";
             if (ar == "152")
             {
         ...
         public void book()
         {
             ...
             else
             {
                 ...
                 {
                     int d = ablock[k];
                     SqlCommand cmd = new SqlCommand("update arazimap set status='book' , CUSTREGNO='" + TextBox21.Text + "' where plotno=" + d + " AND arazi='" + DropDownList3.Text + "'", con1);
                     cmd.ExecuteNonQuery();
                 }
                 con1.Close();
             }
         ...
         public void cancel()
         {
             ...
             else
             {
                 ...
                 {
                     int d = ablock1[k];
                     SqlCommand cmd = new SqlCommand("update arazimap set status='empty' , CUSTREGNO=NULL where plotno=" + d + " AND arazi='" + DropDownList3.Text + "'", con1);
                     cmd.ExecuteNonQuery();
                 }
                 con1.Close();
             }
         ...
         public Double dppay()
         {
             ...
             if (arazi == "152" || arazi == "506" || arazi == "519" || arazi == "239" || arazi == "161GHA" || arazi == "186MI" || arazi == "RAMAI137" || arazi == "159" || arazi == "1452" || arazi == "357"  || arazi == "217" || arazi=="187-KHA" || arazi=="320" || arazi=="356" || arazi=="353" || arazi=="1413" || arazi=="156")
             {
                 if (TextBox4.Text != "")
                 {
         ...
         protected void Button11_Click(object sender, EventArgs e)
         {
             ...
             plotno = plotbind(DropDownList3.Text);
             TextBox20.Text = plotno;
